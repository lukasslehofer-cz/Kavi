                    ...
                    <div class="group bg-white rounded-2xl overflow-hidden border border-gray-200 hover:border-gray-300 transition-all duration-200">
                        ...
                        <a href="<?php echo e(route('roasteries.show', $roastery)); ?>" class="relative block h-56 overflow-hidden bg-gray-50">
                            ...
                            <div class="w-full h-full bg-gray-100 flex items-center justify-center">
                                <span class="text-6xl"><?php echo e($roastery->country_flag); ?></span>
                            </div>
                            <?php endif; ?>
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex items-center gap-1.5 mb-4 text-gray-500">
                                ...
                                <span class="text-sm font-light"><?php echo e($roastery->country); ?><?php if($roastery->city): ?>, <?php echo e($roastery->city); ?><?php endif; ?></span>
                            </div>
            ...
            <div class="border-t border-gray-100 pt-16">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                    ...
                    <div class="bg-white rounded-2xl overflow-hidden border border-gray-200 hover:border-gray-300 transition-all duration-200">
                        <!-- Coffee Image -->
                        <div class="relative h-64 overflow-hidden cursor-pointer bg-gray-50" onclick="openCoffeeModal<?php echo e($coffee->id); ?>()">
                            <?php if($coffee->image): ?>
                        ...
                        <div class="p-5">
                            ...
                            <p class="text-sm text-gray-500 font-light mb-3 flex items-center gap-1">
                                <span class="text-base"><?php echo e($coffee->roastery->country_flag); ?></span>
                                <a href="<?php echo e(route('roasteries.show', $coffee->roastery)); ?>" class="hover:text-gray-900 transition-colors">
