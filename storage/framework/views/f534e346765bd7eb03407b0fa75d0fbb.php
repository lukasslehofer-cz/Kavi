<?php $__env->startSection('title', 'Káva měsíce ' . ucfirst($monthName)); ?>
    ...
    <div class="relative mx-auto max-w-screen-xl px-4 md:px-8">
        <div class="text-center max-w-3xl mx-auto">
            ...
            <h1 class="mb-6 text-4xl md:text-5xl lg:text-6xl font-black text-gray-900">
                Káva měsíce <span class="bg-gradient-to-r from-primary-600 to-pink-600 bg-clip-text text-transparent"><?php echo e(ucfirst($monthName)); ?></span>
            </h1>
...
<div class="bg-white py-12 sm:py-16 lg:py-20">
    <div class="mx-auto max-w-screen-xl px-4 md:px-8">
        ...
        <?php if($roasteries->count() > 0 && $coffees->count() > 0): ?>
            
            <!-- Roasteries Section -->
            <div class="mb-16">
                <div class="text-center mb-12">
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
                        <?php echo e($roasteries->count() === 1 ? 'Pražírna měsíce' : 'Pražírny měsíce'); ?>

                    </h2>
                    <p class="text-lg text-gray-600">
                        <?php echo e($roasteries->count() === 1 ? 'Tentokrát jsme vybrali kávy od této výjimečné pražírny' : 'Tentokrát jsme vybrali kávy od těchto výjimečných pražíren'); ?>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="group bg-white rounded-2xl overflow-hidden shadow-xl border-2 border-gray-200 hover:shadow-2xl hover:border-primary-300 transition-all duration-300">
                        ...
                        <a href="<?php echo e(route('roasteries.show', $roastery)); ?>" class="relative block h-64 overflow-hidden">
                            ...
                            <img src="<?php echo e(asset($roastery->image)); ?>" 
                                 alt="<?php echo e($roastery->name); ?>"
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center gap-2 mb-4 text-gray-600">
                                ...
                                <span class="text-sm font-medium"><?php echo e($roastery->country); ?><?php if($roastery->city): ?>, <?php echo e($roastery->city); ?><?php endif; ?></span>
                            </div>
                            ...
                            <div class="flex gap-3">
                                <a href="<?php echo e(route('roasteries.show', $roastery)); ?>" 
                                ...
                                <a href="<?php echo e($roastery->website_url); ?>" target="_blank" rel="noopener noreferrer"
            ...
            <div class="border-t-2 border-gray-200 pt-16">
                <div class="text-center mb-12">
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
                        Kávy měsíce <?php echo e(ucfirst($monthName)); ?>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-primary-200 hover:shadow-2xl transition-all duration-300">
                        <!-- Coffee Image -->
                        <div class="relative h-80 overflow-hidden cursor-pointer" onclick="openCoffeeModal<?php echo e($coffee->id); ?>()">
                            <?php if($coffee->image): ?>
                            <img src="<?php echo e(asset($coffee->image)); ?>" 
                            ...
                            <div class="absolute top-4 left-4 flex flex-wrap gap-2">
                                <?php if(is_array($coffee->category)): ?>
                                    <?php $__currentLoopData = $coffee->category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($cat === 'espresso'): ?>
                        ...
                        <div class="p-6">
                            ...
                            <?php if($coffee->roastery): ?>
                            <p class="text-sm text-gray-500 font-medium mb-3 flex items-center gap-1">
                                <span class="text-lg"><?php echo e($coffee->roastery->country_flag); ?></span>
                                <a href="<?php echo e(route('roasteries.show', $coffee->roastery)); ?>" class="hover:text-primary-600 transition-colors">
                                    <?php echo e($coffee->roastery->name); ?>

                                </a>
                            </p>
                            <?php endif; ?>

                            <?php if($coffee->short_description): ?>
                            <p class="text-sm text-gray-600 mb-4 line-clamp-3">
                                <?php echo e($coffee->short_description); ?>

                            </p>
                            <?php endif; ?>

                            <button onclick="openCoffeeModal<?php echo e($coffee->id); ?>()" 
                    ...
                    <div id="coffeeModal<?php echo e($coffee->id); ?>" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4" onclick="closeCoffeeModal<?php echo e($coffee->id); ?>(event)">
                        <div class="bg-white rounded-3xl max-w-3xl w-full max-h-[90vh] overflow-y-auto" onclick="event.stopPropagation()">
                            <div class="relative">
                                ...
                                <button onclick="closeCoffeeModal<?php echo e($coffee->id); ?>()" 
                                ...
                                <div class="absolute top-4 left-4">
                                    <span class="bg-primary-600 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg">
                                        Káva měsíce <?php echo e(ucfirst($monthName)); ?>
                            ...
                            <div class="p-8">
                                ...
                                <p class="text-lg text-gray-600 font-medium mb-6 flex items-center gap-2">
                                    <span class="text-2xl"><?php echo e($coffee->roastery->country_flag); ?></span>
                                    <a href="<?php echo e(route('roasteries.show', $coffee->roastery)); ?>" class="hover:text-primary-600 transition-colors font-semibold">
                                        <?php echo e($coffee->roastery->name); ?>
                                ...
                                <div class="prose max-w-none mb-6">
                                    <?php echo nl2br(e($coffee->description)); ?>

                                </div>
                                <?php endif; ?>

                                <?php if($coffee->attributes && is_array($coffee->attributes) && count($coffee->attributes) > 0): ?>
                                <div class="bg-gray-50 rounded-2xl p-6 mb-6">
                                    <h4 class="text-lg font-semibold text-gray-900 mb-4">Parametry kávy</h4>
                                    <div class="grid grid-cols-2 gap-4">
                                        <?php $__currentLoopData = $coffee->attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($value && !is_array($value)): ?>
                                            <div>
                                                <span class="text-sm text-gray-500 block"><?php echo e(ucfirst(str_replace('_', ' ', $key))); ?></span>
                                                <span class="text-base font-medium text-gray-900"><?php echo e($value); ?></span>
                                            </div>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                    ...
                    <script>
                        function openCoffeeModal<?php echo e($coffee->id); ?>() {
                            document.getElementById('coffeeModal<?php echo e($coffee->id); ?>').classList.remove('hidden');
                            document.body.style.overflow = 'hidden';
                        }

                        function closeCoffeeModal<?php echo e($coffee->id); ?>(event) {
                            if (event) {
                                event.stopPropagation();
                            }
                            document.getElementById('coffeeModal<?php echo e($coffee->id); ?>').classList.add('hidden');
        ...
        <?php else: ?>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-12 text-center border-2 border-gray-200">
                ...
                <p class="text-xl text-gray-600 mb-8">
                    Právě vybíráme výjimečné kávy pro měsíc <?php echo e(ucfirst($monthName)); ?>. Brzy vás překvapíme!
                </p>
                <a href="<?php echo e(route('subscriptions.index')); ?>" 
                   class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary-500 to-pink-600 text-white font-semibold rounded-xl hover:from-primary-600 hover:to-pink-700 transition-all duration-200 shadow-md hover:shadow-lg">
                    Zjistit více o předplatném
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/monthly-feature/index.blade.php ENDPATH**/ ?>