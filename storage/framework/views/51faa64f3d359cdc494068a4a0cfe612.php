      ...
      <div class="col-span-full">
        <div class="text-center py-16">
          ...
          <p class="text-gray-600 mb-6">
            <?php if($selectedCountry): ?>
              Pro zemi <?php echo e($selectedCountry); ?> nemáme žádné pražírny. Zkuste vybrat jinou zemi.
            <?php else: ?>
              Momentálně nemáme žádné pražírny v nabídce.
            <?php endif; ?>
          </p>
          <?php if($selectedCountry): ?>
          <a href="<?php echo e(route('roasteries.index')); ?>" class="inline-flex items-center gap-2 bg-primary-600 text-white font-bold py-3 px-6 rounded-xl hover:bg-primary-700 transition-colors">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/roasteries/index.blade.php ENDPATH**/ ?>