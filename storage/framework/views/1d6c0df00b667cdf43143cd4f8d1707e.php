...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-2xl p-8 sticky top-24 shadow-xl border-2 border-gray-200">
                ...
                <div class="space-y-3 mb-6 pb-6 border-b-2 border-gray-200">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-bold text-gray-900 truncate"><?php echo e($item['product']->name); ?></p>
                            <p class="text-xs text-gray-600"><?php echo e($item['quantity']); ?>× <?php echo e(number_format($item['product']->price, 0, ',', ' ')); ?> Kč</p>
                        </div>
                ...
                <a href="<?php echo e(route('cart.index')); ?>" class="block w-full text-center bg-white hover:bg-gray-50 text-gray-900 font-semibold px-8 py-3 rounded-xl shadow-md hover:shadow-lg border-2 border-gray-200 hover:border-gray-300 transition-all duration-200 flex items-center justify-center gap-2">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
