                        ...
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <a href="<?php echo e(route('login')); ?>?redirect=<?php echo e(urlencode(route('checkout.index'))); ?>" class="inline-block bg-white hover:bg-gray-50 text-blue-600 font-medium px-5 py-2 rounded-full border border-blue-200 hover:border-blue-300 transition-all text-sm">
                                        Přihlásit se
                                    </a>
            ...
            <div class="bg-white rounded-2xl p-6 sticky top-24 border border-gray-200">
                ...
                <div class="space-y-3 mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500 font-light"><?php echo e($item['quantity']); ?>× <?php echo e(number_format($item['product']->price, 0, ',', ' ')); ?> Kč</p>
                        </div>
                        <p class="text-sm font-bold text-gray-900"><?php echo e(number_format($item['subtotal'], 0, ',', ' ')); ?> Kč</p>
                    </div>
                    ...
                    <?php if($appliedCoupon ?? null): ?>
                        <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <a href="<?php echo e(route('checkout.index', ['remove_coupon' => 1])); ?>" class="text-xs text-red-600 hover:text-red-800 hover:underline">
                                    Odebrat
                                </a>
                            </div>
                            <p class="text-sm text-green-700 font-mono font-bold"><?php echo e($appliedCoupon->code); ?></p>
                            <p class="text-xs text-green-600 mt-1"><?php echo e($appliedCoupon->getOrderDiscountDescription()); ?></p>
                        </div>
                    <?php else: ?>
                        <details class="group" <?php echo e(request()->has('coupon_code') ? 'open' : ''); ?>>
                            ...
                            <form method="GET" action="<?php echo e(route('checkout.index')); ?>" class="mt-3">
                ...
                <dl class="space-y-3 mb-6">
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <dd class="font-bold">
                            ...
                            <span class="text-green-600 flex items-center gap-1">
                                ...
                                Zdarma
                                <?php if($appliedCoupon && $appliedCoupon->free_shipping): ?>
                                <span class="text-xs">(kupón)</span>
                                <?php endif; ?>
                            </span>
                            <?php else: ?>
                            <span class="text-gray-900"><?php echo e(number_format($shipping, 0, ',', ' ')); ?> Kč</span>
                            <?php endif; ?>
                        </dd>
                    </div>
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <dd class="font-bold text-gray-900"><?php echo e(number_format($totalWithoutVat, 2, ',', ' ')); ?> Kč</dd>
                    </div>
                ...
                <a href="<?php echo e(route('cart.index')); ?>" class="block w-full text-center bg-white hover:bg-gray-50 text-gray-900 font-medium px-6 py-3 rounded-full border border-gray-200 hover:border-gray-300 transition-all duration-200 flex items-center justify-center gap-2">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div id="magic-link-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl">
        ...
        <form method="POST" action="<?php echo e(route('magic-link.send')); ?>" id="checkout-magic-link-form">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="redirect" value="<?php echo e(route('checkout.index')); ?>">
            <div class="mb-4">
