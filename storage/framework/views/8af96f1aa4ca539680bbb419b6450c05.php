        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden lg:flex items-center space-x-10">
                    <a href="<?php echo e(route('home')); ?>" class="text-dark-700 hover:text-primary-500 font-medium transition-colors">Domů</a>
                    <a href="<?php echo e(route('subscriptions.index')); ?>" class="text-dark-700 hover:text-primary-500 font-medium transition-colors">Předplatné</a>
                    <a href="<?php echo e(route('products.index')); ?>" class="text-dark-700 hover:text-primary-500 font-medium transition-colors">Obchod</a>
                    
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard.index')); ?>" class="text-dark-700 hover:text-primary-500 font-medium transition-colors">Můj účet</a>
                        <?php if(auth()->user()->is_admin): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-dark-700 hover:text-primary-500 font-medium transition-colors">Admin</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
                ...
                <div class="flex items-center space-x-6">
                    <!-- Cart Icon -->
                    <a href="<?php echo e(route('cart.index')); ?>" class="relative text-dark-700 hover:text-primary-500 transition-colors">
                    ...
                    <div class="hidden lg:flex items-center space-x-4">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-dark-700 hover:text-primary-500 font-medium transition-colors">Přihlásit se</a>
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary !px-6 !py-2.5 text-sm">Začít nyní</a>
                        <?php endif; ?>
                    </div>
    ...
    <footer class="bg-bluegray-50 border-t border-bluegray-200 mt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-dark-600">
                        <li><a href="<?php echo e(route('subscriptions.index')); ?>" class="hover:text-primary-500 transition-colors">Předplatné</a></li>
                        <li><a href="<?php echo e(route('products.index')); ?>" class="hover:text-primary-500 transition-colors">Všechny produkty</a></li>
            ...
            <div class="border-t border-bluegray-200 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p class="text-dark-600 text-sm">&copy; <?php echo e(date('Y')); ?> Kavi Coffee. Všechna práva vyhrazena.</p>
