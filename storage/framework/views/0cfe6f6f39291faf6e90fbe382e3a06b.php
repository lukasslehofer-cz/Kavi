...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="country" 
                                name="country" 
                                class="input <?php $__errorArgs = ['country'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="AT" <?php echo e(old('country', auth()->user()->country ?? '') == 'AT' ? 'selected' : ''); ?>>Rakousko</option>
                            <option value="BE" <?php echo e(old('country', auth()->user()->country ?? '') == 'BE' ? 'selected' : ''); ?>>Belgie</option>
                            <option value="BG" <?php echo e(old('country', auth()->user()->country ?? '') == 'BG' ? 'selected' : ''); ?>>Bulharsko</option>
                            <option value="HR" <?php echo e(old('country', auth()->user()->country ?? '') == 'HR' ? 'selected' : ''); ?>>Chorvatsko</option>
                            <option value="CY" <?php echo e(old('country', auth()->user()->country ?? '') == 'CY' ? 'selected' : ''); ?>>Kypr</option>
                            <option value="CZ" <?php echo e(old('country', auth()->user()->country ?? 'CZ') == 'CZ' ? 'selected' : ''); ?>>Česká republika</option>
                            <option value="DK" <?php echo e(old('country', auth()->user()->country ?? '') == 'DK' ? 'selected' : ''); ?>>Dánsko</option>
                            <option value="EE" <?php echo e(old('country', auth()->user()->country ?? '') == 'EE' ? 'selected' : ''); ?>>Estonsko</option>
                            <option value="FI" <?php echo e(old('country', auth()->user()->country ?? '') == 'FI' ? 'selected' : ''); ?>>Finsko</option>
                            <option value="FR" <?php echo e(old('country', auth()->user()->country ?? '') == 'FR' ? 'selected' : ''); ?>>Francie</option>
                            <option value="DE" <?php echo e(old('country', auth()->user()->country ?? '') == 'DE' ? 'selected' : ''); ?>>Německo</option>
                            <option value="GR" <?php echo e(old('country', auth()->user()->country ?? '') == 'GR' ? 'selected' : ''); ?>>Řecko</option>
                            <option value="HU" <?php echo e(old('country', auth()->user()->country ?? '') == 'HU' ? 'selected' : ''); ?>>Maďarsko</option>
                            <option value="IE" <?php echo e(old('country', auth()->user()->country ?? '') == 'IE' ? 'selected' : ''); ?>>Irsko</option>
                            <option value="IT" <?php echo e(old('country', auth()->user()->country ?? '') == 'IT' ? 'selected' : ''); ?>>Itálie</option>
                            <option value="LV" <?php echo e(old('country', auth()->user()->country ?? '') == 'LV' ? 'selected' : ''); ?>>Lotyšsko</option>
                            <option value="LT" <?php echo e(old('country', auth()->user()->country ?? '') == 'LT' ? 'selected' : ''); ?>>Litva</option>
                            <option value="LU" <?php echo e(old('country', auth()->user()->country ?? '') == 'LU' ? 'selected' : ''); ?>>Lucembursko</option>
                            <option value="MT" <?php echo e(old('country', auth()->user()->country ?? '') == 'MT' ? 'selected' : ''); ?>>Malta</option>
                            <option value="NL" <?php echo e(old('country', auth()->user()->country ?? '') == 'NL' ? 'selected' : ''); ?>>Nizozemsko</option>
                            <option value="PL" <?php echo e(old('country', auth()->user()->country ?? '') == 'PL' ? 'selected' : ''); ?>>Polsko</option>
                            <option value="PT" <?php echo e(old('country', auth()->user()->country ?? '') == 'PT' ? 'selected' : ''); ?>>Portugalsko</option>
                            <option value="RO" <?php echo e(old('country', auth()->user()->country ?? '') == 'RO' ? 'selected' : ''); ?>>Rumunsko</option>
                            <option value="SK" <?php echo e(old('country', auth()->user()->country ?? '') == 'SK' ? 'selected' : ''); ?>>Slovensko</option>
                            <option value="SI" <?php echo e(old('country', auth()->user()->country ?? '') == 'SI' ? 'selected' : ''); ?>>Slovinsko</option>
                            <option value="ES" <?php echo e(old('country', auth()->user()->country ?? '') == 'ES' ? 'selected' : ''); ?>>Španělsko</option>
                            <option value="SE" <?php echo e(old('country', auth()->user()->country ?? '') == 'SE' ? 'selected' : ''); ?>>Švédsko</option>
                        </select>
