...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-primary-500">
        ...
        <p class="text-lg text-dark-600">Jsme rádi, že vás opět vidíme, <span class="text-primary-600 font-semibold"><?php echo e(auth()->user()->name); ?></span></p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border-l-4 border-primary-500">
        <div class="bg-gradient-to-r from-primary-50 to-pink-50 p-6 border-b border-primary-100">
            <div class="flex justify-between items-start flex-wrap gap-4">
                ...
                <a href="<?php echo e(route('dashboard.subscription')); ?>" class="btn btn-primary font-semibold shadow-lg">
                    <?php if($activeSubscriptions->count() > 1): ?>
                        Zobrazit všechna
                    <?php else: ?>
                        Spravovat
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-dark-800"><?php echo e(number_format($activeSubscription->configured_price, 0, ',', ' ')); ?> Kč</p>
                        <p class="text-xs text-dark-500 mt-1">/ <?php echo e($activeSubscription->frequency_months == 1 ? 'měsíc' : ($activeSubscription->frequency_months . ' měsíce')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-yellow-400">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <a href="<?php echo e(route('subscriptions.index')); ?>" class="btn btn-primary inline-flex items-center gap-2">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div class="bg-bluegray-50 p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <a href="<?php echo e(route('dashboard.orders')); ?>" class="text-primary-600 hover:text-primary-700 font-semibold flex items-center gap-2">
                    Zobrazit všechny
