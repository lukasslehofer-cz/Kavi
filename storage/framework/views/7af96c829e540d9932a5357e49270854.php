<?php $__env->startSection('title', 'Nástěnka - Kavi Coffee'); ?>
    ...
    <div class="bg-white rounded-2xl overflow-hidden border border-gray-200">
        <div class="bg-gray-100 p-6 border-b border-gray-200">
            <div class="flex justify-between items-start flex-wrap gap-4">
                ...
                <a href="<?php echo e(route('dashboard.subscription')); ?>" class="bg-primary-500 hover:bg-primary-600 text-white font-medium px-6 py-2.5 rounded-full transition-all duration-200 inline-flex items-center gap-2">
                    <?php if($activeSubscriptions->count() > 1): ?>
                        Zobrazit všechna
                    <?php else: ?>
                        Spravovat
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900"><?php echo e(number_format($activeSubscription->configured_price, 0, ',', ' ')); ?> Kč</p>
                        <p class="text-xs text-gray-500 mt-0.5 font-light">/ <?php echo e($activeSubscription->frequency_months == 1 ? 'měsíc' : ($activeSubscription->frequency_months . ' měsíce')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-200">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <a href="<?php echo e(route('subscriptions.index')); ?>" class="btn btn-primary inline-flex items-center gap-2 font-medium">
    ...
    <div class="bg-white rounded-2xl overflow-hidden border border-gray-200">
        <div class="bg-gray-50 p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <a href="<?php echo e(route('dashboard.orders')); ?>" class="text-primary-600 hover:text-primary-700 font-medium flex items-center gap-2">
                    Zobrazit všechny
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="text-center py-12 px-4">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="btn btn-primary inline-flex items-center gap-2 font-medium">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                </svg>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/dashboard/index.blade.php ENDPATH**/ ?>