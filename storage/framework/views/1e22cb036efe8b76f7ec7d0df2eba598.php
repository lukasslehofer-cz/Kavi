                        ...
                        <td class="content">
                            ...
                            <div class="info-box" style="background-color: #dbeafe !important; border: 1px solid #93c5fd !important; border-left: 4px solid #3b82f6 !important;" bgcolor="#dbeafe">
                                ...
                                <p class="info-text" style="color: #1e3a8a;">
                                    <strong>Datum zrušení:</strong> <?php echo e(now()->format('j. n. Y')); ?><br><br>
                            ...
                            <div class="info-box" style="background-color: #f0fdf4 !important; border: 1px solid #86efac !important; border-left: 4px solid #10b981 !important;" bgcolor="#f0fdf4">
                                ...
                                <div style="text-align: center; margin: 16px 0;">
                                    <a href="<?php echo e(route('home')); ?>?feedback=true" class="button" style="background-color: #10b981 !important;">
                    ...
                    <tr>
                        <td class="footer">
                            ...
                            <div class="footer-links">
                                ...
                                <a href="<?php echo e(route('subscriptions.index')); ?>" class="footer-link">Nové předplatné</a>
                            </div>
...
<?php /**PATH /var/www/html/resources/views/emails/subscription-cancelled.blade.php ENDPATH**/ ?>