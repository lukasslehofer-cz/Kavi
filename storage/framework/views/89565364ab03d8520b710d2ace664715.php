  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <nav class="text-sm">
        <ol class="flex items-center space-x-2 text-gray-600">
            ...
            <li><a href="<?php echo e(route('products.index')); ?>" class="hover:text-primary-600 transition-colors font-medium">Obchod</a></li>
            <li class="text-gray-400">
              <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
              </svg>
            </li>
            <li class="text-gray-900 font-bold truncate max-w-xs"><?php echo e($product->name); ?></li>
        </ol>
    </nav>
  </div>
</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-20">
        ...
        <div class="lg:sticky lg:top-24 h-fit">
            <div class="relative aspect-square rounded-3xl overflow-hidden shadow-2xl border-2 border-gray-200 bg-gradient-to-br from-gray-100 to-gray-50">
                ...
                <div class="w-full h-full flex flex-col items-center justify-center p-12 bg-gradient-to-br from-primary-100 to-pink-100">
                    ...
                    <p class="text-center text-primary-700 font-semibold"><?php echo e($product->name); ?></p>
                </div>
                <?php endif; ?>
        ...
        <div>
            ...
            <p class="text-lg text-gray-600 font-medium mb-6 flex items-center gap-2">
              <span class="text-2xl"><?php echo e($product->roastery->country_flag); ?></span>
              <a href="<?php echo e(route('roasteries.show', $product->roastery)); ?>" class="hover:text-primary-600 transition-colors font-semibold">
            ...
            <p class="text-xl text-gray-600 mb-8 leading-relaxed"><?php echo e($product->short_description); ?></p>
            <?php endif; ?>
            ...
            <div class="bg-gradient-to-r from-primary-50 to-pink-50 rounded-2xl p-6 mb-8 border-2 border-primary-100">
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-lg font-semibold text-gray-900"><?php echo e($product->attributes['flavor_profile']); ?></p>
                </div>
              </div>
            </div>
            <?php endif; ?>
            ...
            <div class="flex items-baseline gap-3 mb-8 pb-8 border-b-2 border-gray-200">
                <span class="text-6xl font-black bg-gradient-to-r from-primary-600 to-pink-600 bg-clip-text text-transparent"><?php echo e(number_format($product->price, 0, ',', ' ')); ?></span>
                ...
                <div class="bg-gradient-to-br from-gray-50 to-slate-50 rounded-2xl p-6 mb-6 border-2 border-gray-200">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <span class="text-gray-600 font-medium">
                            <span class="font-bold text-gray-900"><?php echo e($product->stock); ?></span> ks skladem
                        </span>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl p-8 border-2 border-gray-200 shadow-lg">
                ...
                <dl class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-slate-50 rounded-xl p-4 border border-gray-200">
                        <dt class="text-gray-600 font-semibold text-sm uppercase tracking-wide mb-1"><?php echo e(str_replace('_', ' ', ucfirst($key))); ?></dt>
    ...
    <section class="mt-20 pt-20 border-t-4 border-gray-200">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="group relative bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-gray-200 hover:border-primary-300">
                <a href="<?php echo e(route('products.show', $relatedProduct)); ?>" class="relative block h-64 overflow-hidden">
                    ...
                    <div class="w-full h-full flex flex-col items-center justify-center p-6 bg-gradient-to-br from-primary-100 to-pink-100">
                        ...
                        <p class="text-center text-xs font-semibold text-primary-600"><?php echo e($relatedProduct->name); ?></p>
                    </div>
                    <?php endif; ?>
                </a>
                <div class="p-5">
                    ...
                    <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                      <span class="text-xl font-black bg-gradient-to-r from-primary-600 to-pink-600 bg-clip-text text-transparent"><?php echo e(number_format($relatedProduct->price, 0, ',', ' ')); ?> Kč</span>
                      <a href="<?php echo e(route('products.show', $relatedProduct)); ?>" class="flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-r from-primary-500 to-pink-600 hover:from-primary-600 hover:to-pink-700 text-white shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-200">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                      </a>
