...
<div class="p-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-6 gap-4 mb-8">
        ...
        <div class="bg-red-50 rounded-lg p-4 text-center shadow-sm border-2 border-red-300 <?php echo e(($stats['unpaid'] ?? 0) > 0 ? 'ring-2 ring-red-500 ring-offset-2' : ''); ?>">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors <?php echo e($order->payment_status === 'unpaid' ? 'bg-red-50 border-l-4 border-red-500' : ''); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <?php if($order->payment_failure_count > 0): ?>
                            <div class="text-xs text-red-700 mt-1">
                                Pokusů: <?php echo e($order->payment_failure_count); ?>
