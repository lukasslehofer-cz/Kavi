<?php $__env->startSection('title', 'Potvrzení objednávky - Kavi Coffee'); ?>
...
<div class="relative bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 py-16 border-b-2 border-green-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="mb-6">
            <div class="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center shadow-2xl animate-bounce" style="animation-duration: 2s;">
        ...
        <p class="text-lg text-gray-600">
            Číslo objednávky: <span class="font-bold text-gray-900">#<?php echo e($order->id); ?></span>
        </p>
    </div>
</div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-xl border-2 border-gray-200">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl font-black text-gray-900">Objednané produkty</h2>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                        <div class="w-20 h-20 rounded-lg overflow-hidden flex-shrink-0 shadow-md">
                            ...
                            <img src="<?php echo e(asset($item->product_image)); ?>" alt="<?php echo e($item->product_name); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="font-bold text-gray-900 mb-1"><?php echo e($item->product_name); ?></div>
                            <div class="text-sm text-gray-600"><?php echo e($item->quantity); ?>× <?php echo e(number_format($item->price, 0, ',', ' ')); ?> Kč</div>
                        </div>
                        <div class="text-lg font-bold text-gray-900">
                            <?php echo e(number_format($item->total, 0, ',', ' ')); ?> Kč
                        </div>
                    </div>
                ...
                <div class="mt-6 pt-6 border-t-2 border-gray-200 space-y-3">
                    <div class="flex justify-between items-center text-gray-700">
                        ...
                        <span class="font-bold"><?php echo e(number_format($order->subtotal, 0, ',', ' ')); ?> Kč</span>
                    </div>
                    <div class="flex justify-between items-center text-gray-700">
                        <span>Doprava:</span>
                    ...
                    <div class="flex justify-between items-center text-gray-700">
                        <span>DPH (21%):</span>
                        <span class="font-bold"><?php echo e(number_format($order->tax, 2, ',', ' ')); ?> Kč</span>
                    </div>
                    <div class="flex justify-between items-center pt-3 border-t-2 border-gray-200">
                        <span class="text-xl font-bold text-gray-900">Celkem:</span>
                        <span class="text-3xl font-black bg-gradient-to-r from-primary-600 to-pink-600 bg-clip-text text-transparent">
                    ...
                    <div class="space-y-3 text-gray-700">
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-bold text-gray-900"><?php echo e($order->shipping_address['name']); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-bold text-gray-900"><?php echo e($order->shipping_address['email']); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-bold text-gray-900"><?php echo e($order->shipping_address['phone']); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-bold text-gray-900"><?php echo e($order->shipping_address['billing_address']); ?>, <?php echo e($order->shipping_address['billing_postal_code']); ?> <?php echo e($order->shipping_address['billing_city']); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php if(!empty($order->shipping_address['packeta_point_name'])): ?>
            <div class="bg-white rounded-2xl p-8 shadow-xl border-2 border-primary-200">
                ...
                <div class="bg-gradient-to-r from-orange-50 to-red-50 p-6 rounded-xl border-2 border-[#ba1b02]/20 shadow-md">
                    ...
                    <div class="text-lg font-black text-gray-900 mb-1"><?php echo e($order->shipping_address['packeta_point_name']); ?></div>
                    <?php if(!empty($order->shipping_address['packeta_point_address'])): ?>
                    <div class="text-sm text-gray-700 flex items-start gap-1">
                        ...
                        <?php echo e($order->shipping_address['packeta_point_address']); ?>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-xl border-2 border-gray-200">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl font-black text-gray-900">📦 Doručovací adresa</h2>
                </div>
                
                <div class="bg-gradient-to-br from-gray-50 to-slate-50 p-6 rounded-xl border border-gray-200">
                    <div class="font-bold text-gray-900 mb-1"><?php echo e($order->shipping_address['name']); ?></div>
                    <div class="text-gray-700"><?php echo e($order->shipping_address['billing_address']); ?></div>
                    <div class="text-gray-700"><?php echo e($order->shipping_address['billing_postal_code']); ?> <?php echo e($order->shipping_address['billing_city']); ?></div>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="bg-white rounded-2xl p-8 sticky top-24 shadow-xl border-2 border-gray-200">
                ...
                <div class="space-y-4 mb-6">
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-gray-600">Na váš email jsme odeslali potvrzení s detaily objednávky</div>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            <div class="font-bold text-gray-900 mb-1">Zpracování objednávky</div>
                            <div class="text-sm text-gray-600">Vaši objednávku připravujeme k odeslání</div>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            <div class="font-bold text-gray-900 mb-1">Sledování zásilky</div>
                            <div class="text-sm text-gray-600">Jakmile odešleme, pošleme vám tracking číslo</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-green-50 border-2 border-green-200 rounded-xl p-4 mb-4">
                    <div class="flex items-center gap-2 text-green-700">
                        ...
                        <span class="font-bold">Platba proběhla úspěšně</span>
                    </div>
                </div>
                <?php endif; ?>

                <div class="space-y-3">
                    <a href="<?php echo e(route('dashboard.orders')); ?>" class="block w-full text-center bg-gradient-to-r from-primary-500 to-pink-600 hover:from-primary-600 hover:to-pink-700 text-white font-bold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                        Zobrazit objednávky
                    </a>
                    
                    <a href="<?php echo e(route('products.index')); ?>" class="block w-full text-center bg-white hover:bg-gray-50 text-gray-900 font-semibold px-8 py-3 rounded-xl shadow-md hover:shadow-lg border-2 border-gray-200 hover:border-gray-300 transition-all duration-200">
                        Pokračovat v nákupu
                    </a>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/checkout/confirmation.blade.php ENDPATH**/ ?>