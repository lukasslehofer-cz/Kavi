...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard - Kavi Coffee'); ?></title>
    ...
    <header class="sticky top-0 z-50 bg-white/70 backdrop-blur-lg border-b border-gray-200/50">
        <div class="mx-auto max-w-screen-xl px-4 md:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-3">
                    <!-- User Account -->
                    <a href="<?php echo e(route('dashboard.index')); ?>" class="flex items-center justify-center w-9 h-9 rounded-full bg-gray-900 hover:bg-gray-800 transition-all duration-200" title="Můj účet">
                    ...
                    <!-- Cart -->
                    <a href="<?php echo e(route('cart.index')); ?>" class="relative flex items-center justify-center w-9 h-9 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors duration-200 group" title="Košík">
        ...
        <div id="mobile-menu" class="lg:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-lg shadow-lg border-t border-gray-200" style="display: none;">
            <div class="max-w-screen-xl mx-auto px-6 py-6 space-y-1">
                <a href="<?php echo e(route('home')); ?>" class="block text-gray-900 hover:text-primary-600 font-medium py-2.5 px-4 rounded-lg hover:bg-gray-50 transition-all">
                    Domů
                </a>
                <a href="<?php echo e(route('subscriptions.index')); ?>" class="block text-gray-900 hover:text-primary-600 font-medium py-2.5 px-4 rounded-lg hover:bg-gray-50 transition-all">
                    Předplatné
                </a>
                <a href="<?php echo e(route('monthly-feature.index')); ?>" class="block text-gray-900 hover:text-primary-600 font-medium py-2.5 px-4 rounded-lg hover:bg-gray-50 transition-all">
                    Káva měsíce
                </a>
                <a href="<?php echo e(route('products.index')); ?>" class="block text-gray-900 hover:text-primary-600 font-medium py-2.5 px-4 rounded-lg hover:bg-gray-50 transition-all">
                    Obchod
                </a>
                <a href="<?php echo e(route('roasteries.index')); ?>" class="block text-gray-900 hover:text-primary-600 font-medium py-2.5 px-4 rounded-lg hover:bg-gray-50 transition-all">
                    Naše pražírny
                </a>
                
                <div class="pt-4 mt-4 border-t border-gray-200 space-y-1">
                    <a href="<?php echo e(route('dashboard.index')); ?>" class="flex items-center gap-3 text-gray-900 hover:text-primary-600 font-medium py-2.5 px-4 rounded-lg hover:bg-gray-50 transition-all">
                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 text-gray-900 hover:text-primary-600 font-medium py-2.5 px-4 rounded-lg hover:bg-gray-50 transition-all">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="bg-white rounded-2xl p-5 sticky top-24 border border-gray-200">
                        ...
                        <div class="flex items-center gap-3 pb-5 border-b border-gray-100 mb-5">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-500 truncate font-light"><?php echo e(auth()->user()->email); ?></p>
                            </div>
                        </div>

                        <!-- Navigation Menu -->
                        <nav class="space-y-1">
                            <a href="<?php echo e(route('dashboard.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('dashboard.index') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-50'); ?>">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="<?php echo e(route('dashboard.profile')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('dashboard.profile') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-50'); ?>">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                </svg>
                            ...
                            <a href="<?php echo e(route('dashboard.orders')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('dashboard.orders') || request()->routeIs('dashboard.order.detail') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-50'); ?>">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                                </svg>
                            ...
                            <a href="<?php echo e(route('dashboard.subscription')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('dashboard.subscription') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-50'); ?>">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="<?php echo e(route('dashboard.notifications')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('dashboard.notifications') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-gray-50'); ?>">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
