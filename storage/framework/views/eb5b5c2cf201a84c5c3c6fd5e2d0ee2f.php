    ...
    <header class="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
        <div class="mx-auto max-w-screen-xl px-4 md:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center gap-4">
                    <!-- User Account -->
                    <a href="<?php echo e(route('dashboard.index')); ?>" class="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-primary-500 to-pink-600 hover:from-primary-600 hover:to-pink-700 transition-all duration-200 shadow-lg" title="Můj účet">
        ...
        <div id="mobile-menu" class="lg:hidden absolute top-full left-0 right-0 bg-white backdrop-blur-xl shadow-2xl border-t-2 border-gray-200" style="display: none;">
            <div class="max-w-screen-xl mx-auto px-6 py-8 space-y-2">
                <a href="<?php echo e(route('home')); ?>" class="block text-gray-900 hover:text-primary-600 font-bold py-3.5 px-4 rounded-xl hover:bg-primary-50 transition-all">
                    Domů
                </a>
                <a href="<?php echo e(route('subscriptions.index')); ?>" class="block text-gray-900 hover:text-primary-600 font-bold py-3.5 px-4 rounded-xl hover:bg-primary-50 transition-all">
                    Předplatné
                </a>
                <a href="<?php echo e(route('products.index')); ?>" class="block text-gray-900 hover:text-primary-600 font-bold py-3.5 px-4 rounded-xl hover:bg-primary-50 transition-all">
                    Obchod
                </a>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 sticky top-28">
                        ...
                        <div class="flex items-center gap-4 pb-6 border-b border-gray-200 mb-6">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-bold text-dark-800 truncate"><?php echo e(auth()->user()->name); ?></p>
                        ...
                        <!-- Navigation Menu -->
                        <nav class="space-y-2">
                            <a href="<?php echo e(route('dashboard.index')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('dashboard.index') ? 'bg-primary-50 text-primary-600 shadow-md border-l-4 border-primary-500' : 'text-dark-700 hover:bg-bluegray-100'); ?>">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="<?php echo e(route('dashboard.profile')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('dashboard.profile') ? 'bg-primary-50 text-primary-600 shadow-md border-l-4 border-primary-500' : 'text-dark-700 hover:bg-bluegray-100'); ?>">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                </svg>
                            ...
                            <a href="<?php echo e(route('dashboard.orders')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('dashboard.orders') || request()->routeIs('dashboard.order.detail') ? 'bg-primary-50 text-primary-600 shadow-md border-l-4 border-primary-500' : 'text-dark-700 hover:bg-bluegray-100'); ?>">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                                </svg>
                            ...
                            <a href="<?php echo e(route('dashboard.subscription')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('dashboard.subscription') ? 'bg-primary-50 text-primary-600 shadow-md border-l-4 border-primary-500' : 'text-dark-700 hover:bg-bluegray-100'); ?>">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="<?php echo e(route('dashboard.notifications')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('dashboard.notifications') ? 'bg-primary-50 text-primary-600 shadow-md border-l-4 border-primary-500' : 'text-dark-700 hover:bg-bluegray-100'); ?>">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <footer class="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border-t-4 border-primary-500 mt-auto">
        <div class="mx-auto max-w-screen-xl px-4 md:px-8">
            <div class="py-8 text-center">
                <p class="text-sm text-gray-400">© <?php echo e(date('Y')); ?> Kavi Coffee. Všechna práva vyhrazena.</p>
            </div>
        </div>
    </footer>
