        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-lg text-gray-600">
                    <span class="font-semibold"><?php echo e(count($cartItems ?? [])); ?></span> 
                            ...
                            <div class="flex justify-between items-start mb-3">
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900 mb-1">
                                        <a href="<?php echo e(route('products.show', $item['product'])); ?>" class="hover:text-primary-600 transition-colors">
                                            <?php echo e($item['product']->name); ?>

                                        </a>
                                    </h3>
                                    <p class="text-gray-600 font-medium"><?php echo e(number_format($item['product']->price, 0, ',', ' ')); ?> Kč / ks</p>
                                </div>
                                <div class="text-right">
                                    <p class="text-2xl font-black bg-gradient-to-r from-primary-600 to-pink-600 bg-clip-text text-transparent"><?php echo e(number_format($item['subtotal'], 0, ',', ' ')); ?> Kč</p>
                                </div>
                            </div>
            ...
            <div class="bg-white rounded-2xl p-8 sticky top-24 shadow-xl border-2 border-gray-200">
                ...
                <dl class="space-y-4 mb-6">
                    <div class="flex justify-between items-center py-3 border-b border-gray-100">
                        ...
                        <dd class="font-bold text-gray-900 text-lg"><?php echo e(number_format($total, 0, ',', ' ')); ?> Kč</dd>
                    </div>
                ...
                <a href="<?php echo e(route('checkout.index')); ?>" class="group w-full flex items-center justify-center gap-2 bg-gradient-to-r from-primary-500 to-pink-600 hover:from-primary-600 hover:to-pink-700 text-white font-bold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 mb-3">
