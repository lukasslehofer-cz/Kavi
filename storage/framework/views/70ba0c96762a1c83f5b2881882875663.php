    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gray-100 p-6 rounded-xl border border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-medium text-gray-900"><?php echo e($frequencyText); ?></div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-600 font-light"><?php echo e($frequencyText); ?></div>
                        </div>
                    </div>
                    
                    <?php if($subscription->discount_amount > 0 && $subscription->coupon): ?>
                    <?php
                    ...
                    <div class="mt-6 pt-6 border-t-2 border-green-200">
                        <div class="bg-green-50 p-5 rounded-xl border border-green-200">
                            <div class="flex items-start gap-3 mb-4">
                                ...
                                <div class="flex-1">
                                    <div class="font-bold text-green-900 mb-1 text-lg">Sleva <?php echo e($subscription->coupon_code); ?> aktivována!</div>
                                    <div class="text-sm text-green-700 font-medium">
                                        Sleva <?php echo e(number_format($subscription->discount_amount, 0, ',', ' ')); ?> Kč
                                        <?php if($subscription->discount_months_total): ?>
                                            po dobu <?php echo e($subscription->discount_months_remaining); ?> <?php echo e($subscription->discount_months_remaining == 1 ? 'platby' : ($subscription->discount_months_remaining < 5 ? 'plateb' : 'plateb')); ?>
                            ...
                            <div class="space-y-3 text-sm">
                                <div class="flex items-center justify-between py-2 px-3 bg-white rounded-lg">
                                    ...
                                    <span class="font-bold text-green-700"><?php echo e(number_format($subscription->configured_price, 0, ',', ' ')); ?> Kč</span>
                                </div>
                                
                                <?php if($subscription->discount_months_total): ?>
                                <div class="flex items-center justify-between py-2 px-3 bg-white rounded-lg">
                                    <span class="text-gray-700">Sleva platí do:</span>
                                    <span class="font-bold text-gray-900"><?php echo e($discountEndsAt->format('j. n. Y')); ?></span>
                                </div>
                                
                                <div class="flex items-center justify-between py-2 px-3 bg-white rounded-lg">
                                    <span class="text-gray-700">Od:</span>
                                    <span class="font-bold text-gray-900"><?php echo e($fullPriceStartsAt->format('j. n. Y')); ?></span>
                                </div>
                                
                                <div class="flex items-center justify-between py-2 px-3 bg-white rounded-lg border-2 border-gray-300">
                                    <span class="text-gray-700">Plná cena od <?php echo e($fullPriceStartsAt->format('j. n.')); ?>:</span>
                                    <span class="font-bold text-gray-900 text-lg"><?php echo e(number_format($originalPrice, 0, ',', ' ')); ?> Kč</span>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200 space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-sm text-gray-700 font-light">
                                    <strong class="text-primary-600 font-medium"><?php echo e($shippingInfo['next_shipping_date']->format('j. n. Y')); ?></strong>
                                    (20. den v měsíci)
                                </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-sm text-gray-700 font-light">
                                    <strong class="text-green-600 font-medium"><?php echo e($nextPaymentDate->format('j. n. Y')); ?></strong>
                                    (15. den v měsíci)
                                </div>
                                <div class="text-xs text-gray-600 mt-1 font-light">
                    ...
                    <div class="space-y-3 text-gray-700">
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-medium text-gray-900"><?php echo e($subscription->shipping_address['name']); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-medium text-gray-900"><?php echo e($subscription->shipping_address['email']); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-medium text-gray-900"><?php echo e($subscription->shipping_address['phone']); ?></div>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-medium text-gray-900"><?php echo e($subscription->shipping_address['billing_address']); ?>, <?php echo e($subscription->shipping_address['billing_postal_code']); ?> <?php echo e($subscription->shipping_address['billing_city']); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl p-8 border border-gray-200">
                ...
                <div class="bg-primary-50 p-6 rounded-xl border border-primary-200">
                    ...
                    <div class="text-lg font-medium text-gray-900 mb-1"><?php echo e($subscription->packeta_point_name); ?></div>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-2xl p-8 sticky top-24 border border-gray-200">
                ...
                <div class="space-y-3">
                    <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard.subscription')); ?>" class="block w-full text-center bg-primary-500 hover:bg-primary-600 text-white font-medium px-6 py-3 rounded-full transition-all duration-200">
                        Zobrazit předplatné
                    </a>
                    <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="block w-full text-center bg-primary-500 hover:bg-primary-600 text-white font-medium px-6 py-3 rounded-full transition-all duration-200">
                        Přihlásit se / Vytvořit účet
                    </a>
                    <?php endif; ?>
                    
                    <a href="<?php echo e(route('home')); ?>" class="block w-full text-center bg-white hover:bg-gray-50 text-gray-900 font-medium px-6 py-3 rounded-full border border-gray-200 hover:border-gray-300 transition-all duration-200">
                        Zpět na homepage
                    </a>
                </div>
