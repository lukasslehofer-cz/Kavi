...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <form action="<?php echo e(route('subscriptions.checkout.process')); ?>" method="POST" id="subscription-checkout-form" class="space-y-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-6 bg-primary-50 rounded-xl p-6 border-2 border-primary-200">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                ...
                                <a href="<?php echo e(route('login')); ?>?redirect=<?php echo e(urlencode(route('subscriptions.checkout'))); ?>" class="btn btn-outline !px-4 !py-2 text-sm">
                                    Přihlásit se
                                </a>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label for="phone" class="block text-sm font-medium text-dark-700 mb-2">
                                Telefon <?php if(auth()->guard()->guest()): ?><span class="text-dark-500">(volitelné)</span><?php else: ?><span class="text-red-500">*</span><?php endif; ?>
                            </label>
                            <input 
                                type="tel" 
                                id="phone" 
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="lg:col-span-1">
            <div class="card p-8 sticky top-24">
                ...
                <a href="<?php echo e(route('subscriptions.index')); ?>" class="btn btn-outline w-full text-center">
