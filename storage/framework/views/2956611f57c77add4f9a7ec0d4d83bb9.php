<?php $__env->startSection('title', 'Obchodní podmínky - Kavi Coffee'); ?>
    ...
    <div class="mx-auto max-w-4xl px-4 md:px-8">
        ...
        <section class="mb-16">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-primary-50 rounded-2xl p-6 border border-primary-200">
                    <p class="text-gray-700 font-light leading-relaxed">
                        <strong class="font-medium text-gray-900">2)</strong> Podrobnější informace o ochraně osobních údajů naleznete v <a href="<?php echo e(route('privacy-policy')); ?>" class="text-primary-600 hover:text-primary-700 font-medium">Zásadách ochrany osobních údajů</a>.
                    </p>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/terms-of-service.blade.php ENDPATH**/ ?>