                    ...
                    <tr>
                        <td class="content">
                            ...
                            <div style="text-align: center; margin: 32px 0;">
                                <a href="<?php echo e(url('/verify-email-change/' . $confirmationToken)); ?>" class="button">
                            ...
                            <p style="font-size: 12px; color: #9ca3af; word-break: break-all; background-color: #f9fafb; padding: 12px; border-radius: 8px; margin: 8px 0;">
                                <?php echo e(url('/verify-email-change/' . $confirmationToken)); ?>
...
<?php /**PATH /Users/lukas/Kavi/resources/views/emails/email-change-confirmation.blade.php ENDPATH**/ ?>