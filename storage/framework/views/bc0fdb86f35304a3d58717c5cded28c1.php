...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="flex flex-wrap gap-3 mb-12 justify-center">
        <a href="<?php echo e(route('products.index')); ?>" 
           class="px-6 py-3 rounded-full font-semibold transition-all <?php echo e(!request('category') ? 'bg-primary-500 text-white shadow-lg' : 'bg-white text-dark-700 border border-bluegray-200 hover:border-primary-500'); ?>">
            Vše
        </a>
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e(route('products.index', ['category' => $key])); ?>" 
           class="px-6 py-3 rounded-full font-semibold transition-all <?php echo e(request('category') == $key ? 'bg-primary-500 text-white shadow-lg' : 'bg-white text-dark-700 border border-bluegray-200 hover:border-primary-500'); ?>">
            <?php echo e($label); ?>
        ...
        <a href="<?php echo e(route('products.show', $product)); ?>" class="card card-hover group">
            <div class="aspect-square overflow-hidden img-placeholder">
                ...
                <div class="w-full h-full flex flex-col items-center justify-center p-8">
                    ...
                    <p class="text-center text-sm">Balení kávy: <?php echo e($product->name); ?></p>
                </div>
                <?php endif; ?>
            </div>
            <div class="p-6">
                ...
                <p class="text-sm text-dark-600 mb-4 line-clamp-2"><?php echo e($product->short_description); ?></p>
                <?php endif; ?>
