    ...
    <div class="mb-12">
      <div class="flex flex-wrap justify-center gap-3">
        <a href="<?php echo e(route('products.index')); ?>" 
           class="group relative inline-flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-bold transition-all duration-200 <?php echo e(!request('category') ? 'bg-gradient-to-r from-primary-500 to-pink-600 text-white shadow-lg hover:shadow-xl transform hover:-translate-y-0.5' : 'bg-white border-2 border-gray-200 text-gray-700 hover:border-primary-300 shadow-md hover:shadow-lg'); ?>">
        ...
        <a href="<?php echo e(route('products.index', ['category' => $key])); ?>" 
           class="group relative inline-flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-bold transition-all duration-200 <?php echo e(request('category') == $key ? 'bg-gradient-to-r from-primary-500 to-pink-600 text-white shadow-lg hover:shadow-xl transform hover:-translate-y-0.5' : 'bg-white border-2 border-gray-200 text-gray-700 hover:border-primary-300 shadow-md hover:shadow-lg'); ?>">
      ...
      <div class="group relative bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-gray-200 hover:border-primary-300">
        ...
        <a href="<?php echo e(route('products.show', $product)); ?>" class="relative block h-80 overflow-hidden">
          ...
          <div class="absolute right-3 top-3 bg-gradient-to-r from-red-500 to-red-600 rounded-lg px-3 py-1.5 shadow-lg">
            <span class="text-xs font-bold uppercase tracking-wider text-white">-<?php echo e($product->discount_percentage); ?>%</span>
          </div>
          <?php endif; ?>
        ...
        <div class="p-5">
          ...
          <div class="flex items-center justify-between pt-3 border-t border-gray-100">
            <div>
              <span class="text-2xl font-black bg-gradient-to-r from-primary-600 to-pink-600 bg-clip-text text-transparent"><?php echo e(number_format($product->price, 0, ',', ' ')); ?></span>
              <span class="text-sm text-gray-600 font-semibold ml-1">Kč</span>
              <?php if($product->original_price ?? false): ?>
              <div class="text-sm text-red-500 line-through font-medium"><?php echo e(number_format($product->original_price, 0, ',', ' ')); ?> Kč</div>
              <?php endif; ?>
            </div>
