...
<div class="bg-white pb-6 sm:pb-8 lg:pb-12">
  <div class="mx-auto max-w-screen-xl px-4 md:px-8">
    ...
    <!-- Configurator -->
    <div class="max-w-5xl mx-auto" id="subscription-configurator" data-pricing='<?php echo json_encode($subscriptionPricing, 15, 512) ?>'>
      ...
      <div id="step-1" class="mb-12">
        <div class="mb-6 grid gap-6 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 lg:gap-8">
          <!-- plan - start -->
          <div class="flex flex-col rounded-lg border p-4 pt-6 coffee-amount-option" data-amount="2" data-cups="500g" data-price="<?php echo e($subscriptionPricing['2']); ?>">
            <div class="mb-12">
          ...
          <!-- plan - start -->
          <div class="flex flex-col rounded-lg border p-4 pt-6 coffee-amount-option" data-amount="3" data-cups="750g" data-price="<?php echo e($subscriptionPricing['3']); ?>">
            <div class="mb-12">
          ...
          <!-- plan - start -->
          <div class="flex flex-col rounded-lg border p-4 pt-6 coffee-amount-option" data-amount="4" data-cups="1000g" data-price="<?php echo e($subscriptionPricing['4']); ?>">
            <div class="mb-12">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('configure-subscription').addEventListener('click', function() {
        ...
        form.method = 'POST';
        form.action = '<?php echo e(route("subscriptions.configure.checkout")); ?>';
