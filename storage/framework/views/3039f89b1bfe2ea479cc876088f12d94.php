            ...
            <div class="card p-8 md:p-12">
                ...
                <div id="step-1" class="config-step active">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        <!-- 500g Option -->
                        <button type="button" class="coffee-amount-option p-6 bg-white hover:bg-primary-500 hover:text-white transition-all text-center group shadow-lg hover:shadow-xl border-2 border-bluegray-200 hover:border-primary-500" data-amount="2" data-cups="500g" data-price="<?php echo e($subscriptionPricing['2']); ?>">
                            <div class="text-4xl font-black text-primary-500 group-hover:text-white mb-3">500 G</div>
                            <div class="text-2xl font-black text-dark-800 group-hover:text-white mb-4"><?php echo e(number_format($subscriptionPricing['2'], 0, ',', ' ')); ?> Kč měsíčně</div>
                        ...
                        <!-- 750g Option - Popular -->
                        <button type="button" class="coffee-amount-option p-6 bg-white hover:bg-primary-500 hover:text-white transition-all text-center group shadow-xl border-4 border-primary-500 relative" data-amount="3" data-cups="750g" data-price="<?php echo e($subscriptionPricing['3']); ?>">
                            ...
                            <div class="text-2xl font-black text-dark-800 group-hover:text-white mb-4"><?php echo e(number_format($subscriptionPricing['3'], 0, ',', ' ')); ?> Kč měsíčně</div>
                        ...
                        <!-- 1000g Option -->
                        <button type="button" class="coffee-amount-option p-6 bg-white hover:bg-primary-500 hover:text-white transition-all text-center group shadow-lg hover:shadow-xl border-2 border-bluegray-200 hover:border-primary-500" data-amount="4" data-cups="1000g" data-price="<?php echo e($subscriptionPricing['4']); ?>">
                            <div class="text-4xl font-black text-primary-500 group-hover:text-white mb-3">1000 G</div>
                            <div class="text-2xl font-black text-dark-800 group-hover:text-white mb-4"><?php echo e(number_format($subscriptionPricing['4'], 0, ',', ' ')); ?> Kč měsíčně</div>
            ...
            <div class="bg-primary-50 border-2 border-primary-200 p-8 mb-6">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-dark-700 mb-3"><strong><?php echo e($shippingInfo['cutoff_message']); ?></strong></p>
...
<section class="section bg-bluegray-50">
    <div class="container-custom">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <?php $__currentLoopData = $coffeesOfMonth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coffee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white overflow-hidden hover:shadow-xl transition-all duration-300 group">
                <div class="aspect-square overflow-hidden bg-bluegray-50 relative">
                    <?php if($coffee->image): ?>
                    <img src="<?php echo e($coffee->image); ?>" alt="<?php echo e($coffee->name); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                    <?php else: ?>
                    <div class="w-full h-full flex flex-col items-center justify-center p-8 bg-gradient-to-br from-bluegray-100 to-bluegray-200">
                        ...
                        <p class="text-center text-xs text-dark-600 font-bold"><?php echo e($coffee->name); ?></p>
                    </div>
                    <?php endif; ?>
                ...
                <div class="p-5">
                    <div class="flex items-start justify-between mb-2">
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-dark-600 mb-3 line-clamp-2"><?php echo e($coffee->short_description); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="pt-3 border-t border-bluegray-100">
                        <button 
                            onclick="showCoffeeModal(<?php echo e($coffee->id); ?>)"
...
function showCoffeeModal(coffeeId) {
    const coffees = <?php echo json_encode($coffeesOfMonth, 15, 512) ?>;
