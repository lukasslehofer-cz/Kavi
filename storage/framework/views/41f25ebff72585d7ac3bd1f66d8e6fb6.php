...
<div class="bg-white py-6 sm:py-8 lg:py-12">
  <div class="mx-auto max-w-screen-xl px-4 md:px-8">
    ...
    <div class="mb-6 grid gap-6 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 lg:gap-8">
      ...
      <div class="relative flex flex-col rounded-lg border-2 border-primary-500 p-4 pt-6">
        ...
        <div class="mt-auto flex flex-col gap-8">
          ...
          <a href="<?php echo e(route('subscriptions.index')); ?>" class="block rounded-lg bg-primary-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-primary-300 transition duration-100 hover:bg-primary-600 focus-visible:ring active:bg-primary-700 md:text-base">Vybrat plán</a>
        </div>
      </div>
      <!-- plan - end -->
    ...
    <div class="text-center text-sm text-gray-500 sm:text-base">Chcete více možností? <a href="<?php echo e(route('subscriptions.index')); ?>" class="text-gray-500 underline transition duration-100 hover:text-primary-500 active:text-primary-600">Konfigurátor předplatného</a></div>
  </div>
</div>
    ...
    <div class="grid gap-x-4 gap-y-8 sm:grid-cols-2 md:gap-x-6 lg:grid-cols-3 xl:grid-cols-4">
      ...
      <div>
        <a href="<?php echo e(route('products.show', $product)); ?>" class="group relative mb-2 block h-80 overflow-hidden rounded-lg bg-gray-100 lg:mb-3">
          ...
          <img src="<?php echo e($product->image); ?>" loading="lazy" alt="<?php echo e($product->name); ?>" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
          <?php else: ?>
