    ...
    <section class="min-h-96 relative flex flex-1 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-gray-100 py-16 shadow-lg md:py-20 xl:py-48">
      ...
      <div class="relative flex flex-col items-center p-4 sm:max-w-xl">
        ...
        <div class="flex w-full flex-col gap-2.5 sm:flex-row sm:justify-center">
          <a href="<?php echo e(route('subscriptions.index')); ?>" class="inline-block rounded-lg bg-primary-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Sestavte si vlastní box</a>

          <a href="<?php echo e(route('products.index')); ?>" class="inline-block rounded-lg bg-gray-200 px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base">Jak to funguje?</a>
        </div>
      </div>
      <!-- text end -->
    </section>
