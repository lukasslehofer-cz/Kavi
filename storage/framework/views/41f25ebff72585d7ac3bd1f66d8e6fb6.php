    ...
    <div class="relative h-full flex items-center justify-center px-4 md:px-8">
        <div class="max-w-4xl mx-auto text-center space-y-6 animate-fade-in">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="group inline-flex items-center justify-center gap-2 bg-white/10 backdrop-blur-md hover:bg-white/20 text-white font-bold text-base px-8 py-4 rounded-xl shadow-xl border-2 border-white/30 hover:border-white/50 transform hover:-translate-y-1 transition-all duration-200">
