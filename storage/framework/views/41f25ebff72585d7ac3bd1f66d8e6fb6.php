...
<section class="section bg-bluegray-50" id="subscriptions">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-5xl mx-auto">
            <!-- 500g Plan -->
            <a href="<?php echo e(route('subscriptions.index')); ?>" class="bg-white hover:bg-bluegray-50 transition-all text-center group shadow-lg hover:shadow-xl border-2 border-bluegray-200 hover:border-primary-500 p-6">
                <div class="text-4xl font-black text-primary-500 group-hover:scale-110 transition-transform mb-3">500 G</div>
                <div class="text-2xl font-black text-dark-800 mb-4"><?php echo e(number_format($subscriptionPricing['2'], 0, ',', ' ')); ?> Kč měsíčně</div>
            ...
            <!-- 750g Plan - Popular -->
            <a href="<?php echo e(route('subscriptions.index')); ?>" class="bg-white hover:bg-primary-50 transition-all text-center group shadow-xl border-4 border-primary-500 relative p-6">
                ...
                <div class="text-2xl font-black text-dark-800 mb-4"><?php echo e(number_format($subscriptionPricing['3'], 0, ',', ' ')); ?> Kč měsíčně</div>
            ...
            <a href="<?php echo e(route('subscriptions.index')); ?>" class="bg-white hover:bg-bluegray-50 transition-all text-center group shadow-lg hover:shadow-xl border-2 border-bluegray-200 hover:border-primary-500 p-6">
                ...
                <div class="text-2xl font-black text-dark-800 mb-4"><?php echo e(number_format($subscriptionPricing['4'], 0, ',', ' ')); ?> Kč měsíčně</div>
        ...
        <div class="text-center">
            ...
            <a href="<?php echo e(route('subscriptions.index')); ?>" class="text-primary-500 hover:text-primary-600 font-bold inline-flex items-center">
