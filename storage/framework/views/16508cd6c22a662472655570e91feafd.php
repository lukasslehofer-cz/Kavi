...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <form action="<?php echo e(route('admin.products.store')); ?>" method="POST" enctype="multipart/form-data" class="card p-8">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <select name="roastery_id" class="input <?php $__errorArgs = ['roastery_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <option value="<?php echo e($roastery->id); ?>" <?php echo e(old('roastery_id') == $roastery->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-primary-50 border-2 border-primary-200 p-6 rounded-lg">
                <div class="flex items-start gap-3 mb-4">
                    ...
                    <div class="flex-1">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="is_coffee_of_month" value="1" <?php echo e(old('is_coffee_of_month') ? 'checked' : ''); ?>
                ...
                <div id="coffee-of-month-date-container" style="display: none;">
                    ...
                    <select name="coffee_of_month_date" class="input <?php $__errorArgs = ['coffee_of_month_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
