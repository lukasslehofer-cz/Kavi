<?php $__env->startSection('title', 'Upravit pražírnu'); ?>
...
<div class="p-6">
    <div class="max-w-4xl mx-auto">
        ...
        <form action="<?php echo e(route('admin.roasteries.update', $roastery)); ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <?php echo csrf_field(); ?>
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', $roastery->name)); ?>" required 
...
unset($__errorArgs, $__bag); ?>" id="country-select">
                                    ...
                                    <option value="<?php echo e($country); ?>" data-flag="<?php echo e($flag); ?>" <?php echo e(old('country', $roastery->country) == $country ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="city" value="<?php echo e(old('city', $roastery->city)); ?>" 
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('address', $roastery->address)); ?></textarea>
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="url" name="website_url" value="<?php echo e(old('website_url', $roastery->website_url)); ?>" placeholder="https://..." 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="instagram" value="<?php echo e(old('instagram', $roastery->instagram)); ?>" placeholder="@prazirna" 
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('short_description', $roastery->short_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('full_description', $roastery->full_description)); ?></textarea>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <img src="<?php echo e(asset($roastery->image)); ?>" alt="<?php echo e($roastery->name); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <?php if($roastery->gallery && count($roastery->gallery) > 0): ?>
                            <div class="mb-4">
                                <p class="text-sm text-gray-600 mb-2">Aktuální galerie:</p>
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <?php $__currentLoopData = $roastery->gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galleryImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="relative">
                                        <img src="<?php echo e(asset($galleryImage)); ?>" alt="Gallery" 
                                        ...
                                        <label class="absolute top-2 right-2 bg-red-600 text-white text-xs px-2 py-1 rounded cursor-pointer hover:bg-red-700">
                                            <input type="checkbox" name="remove_gallery[]" value="<?php echo e($galleryImage); ?>" class="mr-1">
                                            Smazat
                                        </label>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="sort_order" value="<?php echo e(old('sort_order', $roastery->sort_order)); ?>" min="0" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $roastery->is_active) ? 'checked' : ''); ?>
            ...
            <input type="hidden" name="country_flag" id="country-flag-input" value="<?php echo e(old('country_flag', $roastery->country_flag)); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/roasteries/edit.blade.php ENDPATH**/ ?>