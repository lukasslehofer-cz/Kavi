...
<div class="space-y-6">
    ...
    <?php if(request('payment') === 'cancelled'): ?>
        ...
        <div class="bg-gray-100 p-6 border-b border-gray-200">
            <div class="flex justify-between items-start flex-wrap gap-4">
                <div class="flex-1">
                    ...
                    <?php else: ?>
                        <h2 class="text-xl font-bold text-gray-900 mb-1">Kávové předplatné <?php echo e($subscription->subscription_number ?? '#' . $subscription->id); ?></h2>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-red-800 mb-3">
                                    ...
                                    <?php if($subscription->last_payment_failure_at): ?>
                                        <span class="block mt-1">
                                            Datum selhání: <?php echo e($subscription->last_payment_failure_at->format('d.m.Y H:i')); ?>

                                        </span>
                                    <?php endif; ?>
                                    <?php if($subscription->last_payment_failure_reason): ?>
                                        <span class="block mt-1">
                                            Důvod: <?php echo e($subscription->last_payment_failure_reason); ?>
                                ...
                                <?php if($subscription->pending_invoice_amount): ?>
                                <div class="bg-white rounded-lg p-4 mb-4 border border-red-200">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <span class="text-xl font-bold text-red-600"><?php echo e(number_format($subscription->pending_invoice_amount, 0, ',', ' ')); ?> Kč</span>
                                    </div>
                                </div>
                                <?php endif; ?>
                                <form method="POST" action="<?php echo e(route('dashboard.subscription.pay', $subscription)); ?>">
                                    <?php echo csrf_field(); ?>
