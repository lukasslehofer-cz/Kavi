                        ...
                        <td class="content">
                            ...
                            <div class="info-box" style="background-color: #d1fae5 !important; border: 1px solid #86efac !important; border-left: 4px solid #10b981 !important;" bgcolor="#d1fae5">
                                ...
                                <p class="info-text" style="color: #047857;">
                                    <strong>Datum změny:</strong> <?php echo e(now()->format('j. n. Y H:i')); ?><br>
                                    <strong>Email účtu:</strong> <?php echo e($user->email); ?><br><br>
                            ...
                            <div class="info-box" style="background-color: #f3f4f6 !important; border: 1px solid #e5e7eb !important;" bgcolor="#f3f4f6">
                                ...
                                <p class="info-text">
                                    <strong><?php echo e(ucfirst($cardBrand)); ?></strong> končící na <strong>•••• <?php echo e($cardLast4); ?></strong>
                                </p>
                            </div>
                    ...
                    <tr>
                        <td class="footer">
                            ...
                            <div class="footer-links">
                                ...
                                <a href="<?php echo e(route('dashboard.subscription')); ?>" class="footer-link">Předplatné</a>
                                <a href="<?php echo e(route('dashboard.profile')); ?>" class="footer-link">Můj účet</a>
                            </div>
...
<?php /**PATH /Users/lukas/Kavi/resources/views/emails/payment-method-changed.blade.php ENDPATH**/ ?>