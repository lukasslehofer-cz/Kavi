                    ...
                    <tr>
                        <td class="content">
                            ...
                            <div class="info-box" style="background-color: #dbeafe !important; border: 1px solid #93c5fd !important; border-left: 4px solid #3b82f6 !important;" bgcolor="#dbeafe">
                                <h3 class="info-title" style="color: #1e40af;">🎉 Ahoj, <?php echo e($user->name); ?>!</h3>
                            ...
                            <div style="text-align: center; margin: 32px 0;">
                                <a href="<?php echo e(route('subscriptions.index')); ?>" class="button">
                            ...
                            <div class="info-box" style="background-color: #f3f4f6 !important; border: 1px solid #e5e7eb !important;" bgcolor="#f3f4f6">
                                ...
                                <p class="info-text">
                                    ...
                                    <strong>Jméno:</strong> <?php echo e($user->name); ?><br><br>
                                    
                                    Všechny informace můžete spravovat ve svém účtu.
                                </p>
                                <div style="text-align: center; margin-top: 16px;">
                                    <a href="<?php echo e(route('dashboard.profile')); ?>" style="color: #e6305a; text-decoration: none; font-weight: 600;">
                                        Upravit profil →
                                    </a>
                                </div>
                            </div>
                    ...
                    <tr>
                        <td class="footer">
                            ...
                            <div class="footer-links">
                                ...
                                <a href="<?php echo e(route('subscriptions.index')); ?>" class="footer-link">Předplatné</a>
                            </div>
...
<?php /**PATH /Users/lukas/Kavi/resources/views/emails/welcome.blade.php ENDPATH**/ ?>