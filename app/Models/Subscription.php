...
class Subscription extends Model
{
    ...
    /**
     * Zrušení ke konci zaplaceného období. Jediná implementace je
     * SubscriptionShipmentService::cancelSubscription() - ruší i neplacené pending boxy,
     * které by jinak zůstaly viset v rozesílce.
     */
    public function cancel()
    {
        app(\App\Services\SubscriptionShipmentService::class)->cancelSubscription($this);
    }
