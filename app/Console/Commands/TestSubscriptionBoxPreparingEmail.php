...
class TestSubscriptionBoxPreparingEmail extends Command
{
    protected $signature = 'email:test-subscription-box-preparing {email} {--subscription-id=}';
    protected $description = 'Send a test subscription box preparing email';
    ...
    public function handle()
    {
        ...
        try {
            ...
            $this->info("Subscription box preparing email sent to {$email}");
            return 0;
        } catch (\Exception $e) {
