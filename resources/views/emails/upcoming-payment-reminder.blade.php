                        ...
                        <td style="padding: 48px 40px; color: #4a4a4a; background-color: #e5e6df;">
                            ...
                            <div style="margin: 32px 0; padding: 20px 24px; border-left: 3px solid #4a6741; background-color: #d5d7ca;">
                                <div style="font-size: 11px; font-weight: 400; color: #1c1c1c; text-transform: uppercase; letter-spacing: 0.15em; margin-bottom: 8px;">
                                    {{ $locale === 'cs' ? 'Nadcházející platba' : 'Upcoming payment' }}
                                </div>
                                <p style="font-size: 15px; color: #4a6741; margin: 0;">
                                    @if($locale === 'cs')
                                    Za několik dní proběhne pravidelná platba za vaše kávové předplatné.
                                    @else
                                    In a few days, the recurring payment for your coffee subscription will be processed.
                                    @endif
                                </p>
                            </div>
                            ...
                            <div style="margin: 32px 0; padding-top: 24px; border-top: 2px solid #CA4136;">
                                <div style="font-size: 11px; font-weight: 400; color: #76716C; margin: 0 0 16px 0; text-transform: uppercase; letter-spacing: 0.15em;">
                                    {{ $locale === 'cs' ? 'Detaily platby' : 'Payment details' }}
                                </div>
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        ...
                                        <td style="padding: 8px 0; font-size: 16px; color: #1c1c1c; text-align: right; font-weight: 400;">
                                            {{ $subscription->next_billing_date ? $subscription->next_billing_date->format('j. n. Y') : '' }}
                                        </td>
                                    </tr>
                                    @php
                            ...
                            <div style="margin: 32px 0; padding-top: 24px; border-top: 2px solid #CA4136;">
                                <div style="font-size: 11px; font-weight: 400; color: #76716C; margin: 0 0 16px 0; text-transform: uppercase; letter-spacing: 0.15em;">
                                    {{ $locale === 'cs' ? 'Před platbou můžete' : 'Before payment you can' }}
                                </div>
                                <p style="font-size: 15px; color: #1c1c1c; line-height: 1.8; margin: 4px 0;">
                                    ...
                                    <span style="color: #CA4136;">→</span> {{ $locale === 'cs' ? 'Aktualizovat doručovací údaje' : 'Update delivery details' }}<br>
                                    <span style="color: #CA4136;">→</span> {{ $locale === 'cs' ? 'Pozastavit předplatné' : 'Pause subscription' }}
                                </p>
                            </div>
