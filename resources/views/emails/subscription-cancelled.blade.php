                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="email-container" width="100%" style="width: 100%; max-width: 600px; background-color: #ffffff !important; border: 1px solid #e5e7eb !important; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);" bgcolor="#ffffff">
                    ...
                    <tr>
                        <td class="content">
                            ...
                            <h1 style="text-align: center;">{{ __('emails.subscription_cancelled.title', [], $locale) }}</h1>
                            <p class="subtitle" style="text-align: center;">{{ __('emails.subscription_cancelled.subtitle', [], $locale) }}</p>
                            ...
                            <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 12px; padding: 16px; margin: 24px 0; text-align: center;">
                                <div style="font-size: 14px; color: #6b7280; font-weight: 500; margin-bottom: 4px;">{{ __('emails.subscription_cancelled.subscription_number', [], $locale) }}</div>
                            ...
                            <div class="info-box" style="background-color: #dbeafe !important; border: 1px solid #93c5fd !important; border-left: 4px solid #3b82f6 !important;" bgcolor="#dbeafe">
                                <h3 class="info-title" style="color: #1e40af;">✓ {{ $locale === 'cs' ? 'Potvrzení zrušení' : 'Cancellation Confirmation' }}</h3>
                            ...
                            <div class="info-box" style="background-color: #f3f4f6 !important; border: 1px solid #e5e7eb !important;" bgcolor="#f3f4f6">
                                <h3 class="info-title">🔄 {{ __('emails.subscription_cancelled.reactivate', [], $locale) }}</h3>
                                <p class="info-text">
                                    @if($locale === 'cs')
                            ...
                            <p style="font-size: 14px; color: #6b7280; line-height: 1.6; margin-top: 32px; font-weight: 300; text-align: center;">
                                <strong>{{ $locale === 'cs' ? 'Děkujeme, že jste byli součástí ' . $siteName . '!' : 'Thank you for being part of ' . $siteName . '!' }}</strong><br>
