...
<head>
    ...
    <title>{{ __('emails.digital_delivery.title', [], $locale) }}</title>
    <style>
        /* Reset styles */
                    ...
                    <tr>
                        <td style="padding: 48px 40px; color: #4a4a4a; background-color: #e5e6df;">
                            ...
                            <div style="margin: 32px 0; padding: 20px 24px; border-left: 3px solid #4a6741; background-color: #d5d7ca;">
                                ...
                                <p style="font-size: 14px; color: #5a5a5a; margin: 0 0 8px 0; line-height: 1.6;">
                                    {{ __('emails.digital_delivery.message', [], $locale) }}
                                </p>
                                <p style="font-size: 14px; color: #1c1c1c; font-weight: 400; margin: 0;">
                                    {{ __('emails.digital_delivery.enjoy', [], $locale) }}
                                </p>
                            </div>
