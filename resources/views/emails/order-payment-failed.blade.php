                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="email-container" width="100%" style="width: 100%; max-width: 600px; background-color: #ffffff !important; border: 1px solid #e5e7eb !important; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);" bgcolor="#ffffff">
                    ...
                    <tr>
                        <td class="content">
                            ...
                            <h1 style="text-align: center;">{{ __('emails.order_payment_failed.title', [], $locale) }}</h1>
                            <p class="subtitle" style="text-align: center;">{{ __('emails.order_payment_failed.subtitle', [], $locale) }}</p>
                            ...
                            <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 12px; padding: 16px; margin: 24px 0; text-align: center;">
                                <div style="font-size: 14px; color: #6b7280; font-weight: 500; margin-bottom: 4px;">{{ __('emails.order_payment_failed.order_number', [], $locale) }}</div>
                                <div style="font-size: 20px; font-weight: 700; color: #111827;">{{ $order->order_number }}</div>
                                <div style="font-size: 16px; color: #e6305a; font-weight: 600; margin-top: 8px;">{{ \App\Helpers\CurrencyHelper::formatByCurrency($order->total, $order->currency, 0) }}</div>
                            </div>
                            ...
                            <div class="info-box" style="background-color: #fee2e2 !important; border: 1px solid #fca5a5 !important; border-left: 4px solid #ef4444 !important;" bgcolor="#fee2e2">
                                ...
                                <p class="info-text" style="color: #7f1d1d;">
                                    @if($failureReason)
                                    <strong>{{ __('emails.order_payment_failed.reason', [], $locale) }}:</strong> {{ $failureReason }}<br><br>
                                    @endif
                                    @if($locale === 'cs')
                                    ...
                                    @else
                                    Payment for your order failed. Common causes:
                                    <br><br>
                            ...
                            <div class="info-box" style="background-color: #fef3c7 !important; border: 1px solid #fcd34d !important; border-left: 4px solid #f59e0b !important;" bgcolor="#fef3c7">
                                ...
                                <p class="info-text" style="color: #78350f;">
                                    ...
                                    @else
                                    <strong>You have 7 days</strong> to complete the payment.<br><br>
                    ...
                    <tr>
                        <td class="footer">
                            ...
                            <div class="footer-links">
                                ...
                                <a href="{{ route('dashboard.orders') }}" class="footer-link">{{ $locale === 'cs' ? 'Moje objednávky' : 'My Orders' }}</a>
                            </div>
