...
<section class="section bg-white">
    <div class="container-custom">
            ...
            <a href="{{ route('products.show', $product) }}" class="card card-hover group">
                <div class="aspect-square overflow-hidden img-placeholder">
                    ...
                    <div class="w-full h-full flex flex-col items-center justify-center p-8">
                        ...
                        <p class="text-center text-sm">Obrázek balení kávy: {{ $product->name }}</p>
                    </div>
                    @endif
                </div>
                <div class="p-6">
                    ...
                    <p class="text-dark-600 mb-4 line-clamp-2 text-sm">{{ $product->short_description }}</p>
                    @endif
        ...
        <div class="text-center mt-12">
            <a href="{{ route('products.index') }}" class="btn btn-outline text-lg">Zobrazit všechny produkty</a>
        </div>
    </div>
</section>
@endif
...
<section class="section bg-gradient-to-br from-primary-500 to-primary-700 text-white relative overflow-hidden">
    ...
    <div class="relative container-custom text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('subscriptions.index') }}" class="btn btn-white text-lg">
                Začít nyní
            </a>
