  ...
  <div class="relative mx-auto max-w-screen-xl px-4 md:px-8">
    ...
    <div class="mb-16 sm:mb-20">
      <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 max-w-full">
        ...
        <!-- Review Widget - Google Business for CZ, Trustpilot for EN -->
        <div class="w-full md:w-auto md:flex-shrink-0">
          ...
          @else
            ...
            <a href="https://g.page/r/CUKHHPAV65MnEBM/review" target="_blank" rel="noopener" class="inline-flex items-center gap-3 px-6 py-3 bg-white border-2 border-gray-200 rounded-full hover:border-primary-500 hover:shadow-lg transition-all duration-300 group">
              ...
              <div class="text-left">
                <div class="text-sm font-semibold text-gray-900 group-hover:text-primary-600 transition-colors">Ohodnoťte nás na Google</div>
                <div class="text-xs text-gray-500">Vaše recenze nám pomáhá</div>
              </div>
              <svg class="w-4 h-4 text-gray-400 group-hover:text-primary-500 group-hover:translate-x-1 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
