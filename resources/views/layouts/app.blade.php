...
<body class="min-h-screen flex flex-col">
    ...
    <div class="bg-white">
        <div class="flex flex-wrap bg-dark-800 px-4 py-3 sm:flex-nowrap sm:items-center sm:justify-center sm:gap-3 md:px-8">
            ...
            <a href="{{ route('subscriptions.index') }}" class="order-last inline-block w-full whitespace-nowrap rounded-lg bg-dark-900 px-4 py-2 text-center text-xs font-semibold text-white outline-none ring-dark-700 transition duration-100 hover:bg-dark-700 focus-visible:ring active:bg-dark-600 sm:order-none sm:w-auto md:text-sm">
                Zjistit více
            </a>
        </div>
    </div>
    ...
    <header class="bg-white sticky top-0 z-50 border-b mb-8">
        <div class="mx-auto flex max-w-screen-xl items-center justify-between px-4 md:px-8">
            ...
            <nav class="hidden gap-12 lg:flex 2xl:ml-16">
                <a href="{{ route('home') }}" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-primary-500 active:text-primary-700">Domů</a>
                <a href="{{ route('subscriptions.index') }}" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-primary-500 active:text-primary-700">Předplatné</a>
                <a href="{{ route('products.index') }}" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-primary-500 active:text-primary-700">Obchod</a>
            ...
            <div class="flex divide-x border-r sm:border-l">
                @auth
                <a href="{{ route('dashboard.index') }}" class="flex h-12 w-12 flex-col items-center justify-center gap-1.5 transition duration-100 hover:bg-gray-100 active:bg-gray-200 sm:h-20 sm:w-20 md:h-24 md:w-24">
                ...
                <a href="{{ route('cart.index') }}" class="relative flex h-12 w-12 flex-col items-center justify-center gap-1.5 transition duration-100 hover:bg-gray-100 active:bg-gray-200 sm:h-20 sm:w-20 md:h-24 md:w-24">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-800" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div id="mobile-menu" class="lg:hidden border-t" style="display: none;">
            <div class="flex flex-col max-w-screen-xl mx-auto px-4 py-4">
                <a href="{{ route('home') }}" class="text-gray-600 hover:text-primary-500 font-semibold py-2 transition-colors">Domů</a>
                <a href="{{ route('subscriptions.index') }}" class="text-gray-600 hover:text-primary-500 font-semibold py-2 transition-colors">Předplatné</a>
                <a href="{{ route('products.index') }}" class="text-gray-600 hover:text-primary-500 font-semibold py-2 transition-colors">Obchod</a>
                <a href="#" class="text-gray-600 hover:text-primary-500 font-semibold py-2 transition-colors">O nás</a>
                
                <div class="pt-4 mt-4 border-t border-gray-200">
                    @auth
                        <a href="{{ route('dashboard.index') }}" class="block text-gray-600 hover:text-primary-500 font-semibold py-2 transition-colors">Můj účet</a>
                        @if(auth()->user()->is_admin)
                        <a href="{{ route('admin.dashboard') }}" class="block text-gray-600 hover:text-primary-500 font-semibold py-2 transition-colors">Admin</a>
                        @endif
                    ...
                    @else
                        <a href="{{ route('login') }}" class="block text-gray-600 hover:text-primary-500 font-semibold py-2 transition-colors">Přihlásit se</a>
                        <a href="{{ route('register') }}" class="block bg-primary-500 hover:bg-primary-600 text-white px-6 py-2.5 font-semibold text-sm transition-all text-center mt-2 rounded-lg">Registrovat</a>
                    @endauth
                </div>
            </div>
        </div>
    ...
    <div class="bg-gray-900 mt-12">
      <footer class="mx-auto max-w-screen-xl px-4 md:px-8">
        <div class="mb-16 grid grid-cols-2 gap-12 pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
          <div class="col-span-full lg:col-span-2">
            ...
            <div class="mb-4 lg:-mt-2">
              <a href="{{ route('home') }}" class="inline-flex items-center gap-2 text-xl font-bold text-gray-100 md:text-2xl" aria-label="logo">
          ...
          <div>
            ...
            <nav class="flex flex-col gap-4">
              <div>
                <a href="{{ route('subscriptions.index') }}" class="text-gray-400 transition duration-100 hover:text-primary-500 active:text-primary-600">Konfigurátor</a>
              </div>

              <div>
                <a href="{{ route('subscriptions.index') }}" class="text-gray-400 transition duration-100 hover:text-primary-500 active:text-primary-600">Espresso BOX</a>
              </div>

              <div>
                <a href="{{ route('subscriptions.index') }}" class="text-gray-400 transition duration-100 hover:text-primary-500 active:text-primary-600">Filter BOX</a>
              </div>

              <div>
                <a href="{{ route('subscriptions.index') }}" class="text-gray-400 transition duration-100 hover:text-primary-500 active:text-primary-600">Dárkové</a>
              </div>
            </nav>
          </div>
          <!-- nav - end -->
          ...
          <div>
            ...
            <nav class="flex flex-col gap-4">
              <div>
                <a href="{{ route('products.index') }}" class="text-gray-400 transition duration-100 hover:text-primary-500 active:text-primary-600">Všechny produkty</a>
              </div>

              <div>
                <a href="{{ route('products.index', ['category' => 'coffee']) }}" class="text-gray-400 transition duration-100 hover:text-primary-500 active:text-primary-600">Káva</a>
              </div>

              <div>
                <a href="{{ route('products.index', ['category' => 'equipment']) }}" class="text-gray-400 transition duration-100 hover:text-primary-500 active:text-primary-600">Vybavení</a>
              </div>

              <div>
                <a href="{{ route('products.index', ['category' => 'merch']) }}" class="text-gray-400 transition duration-100 hover:text-primary-500 active:text-primary-600">Merch</a>
              </div>
            </nav>
          </div>
          <!-- nav - end -->
        ...
        <div class="border-t border-gray-800 py-8 text-center text-sm text-gray-400">© {{ date('Y') }} Kavi Coffee. Všechna práva vyhrazena.</div>
      </footer>
    </div>
