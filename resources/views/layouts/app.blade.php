        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-24">
                ...
                <div class="hidden lg:flex items-center space-x-12">
                    <a href="{{ route('home') }}" class="text-dark-800 hover:text-primary-500 font-black uppercase text-sm tracking-widest transition-colors">Domů</a>
                    <a href="{{ route('subscriptions.index') }}" class="text-dark-800 hover:text-primary-500 font-black uppercase text-sm tracking-widest transition-colors">Předplatné</a>
                    <a href="{{ route('products.index') }}" class="text-dark-800 hover:text-primary-500 font-black uppercase text-sm tracking-widest transition-colors">Obchod</a>
                    
                    @auth
                        <a href="{{ route('dashboard.index') }}" class="text-dark-800 hover:text-primary-500 font-black uppercase text-sm tracking-widest transition-colors">Účet</a>
                        @if(auth()->user()->is_admin)
                        <a href="{{ route('admin.dashboard') }}" class="text-dark-800 hover:text-primary-500 font-black uppercase text-sm tracking-widest transition-colors">Admin</a>
                        @endif
                    @endauth
                </div>
                ...
                <div class="flex items-center space-x-6">
                    <!-- Cart Icon -->
                    <a href="{{ route('cart.index') }}" class="relative p-4 bg-bluegray-100 hover:bg-primary-500 transition-all group">
                    ...
                    <div class="hidden lg:flex items-center space-x-6">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="text-dark-800 hover:text-primary-500 font-black uppercase text-sm tracking-widest transition-colors">Přihlásit</a>
                            <a href="{{ route('register') }}" class="btn btn-primary !px-8 !py-3 text-xs">Začít →</a>
                        @endauth
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-16">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li><a href="{{ route('subscriptions.index') }}" class="text-bluegray-300 hover:text-white font-bold uppercase text-sm tracking-widest transition-colors">Předplatné</a></li>
                        <li><a href="{{ route('products.index') }}" class="text-bluegray-300 hover:text-white font-bold uppercase text-sm tracking-widest transition-colors">Produkty</a></li>
            ...
            <div class="pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p class="text-bluegray-400 text-sm font-bold uppercase tracking-widest">&copy; {{ date('Y') }} Kavi • Všechna práva vyhrazena</p>
