    ...
    <header class="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
        <div class="mx-auto max-w-screen-xl px-4 md:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <nav class="hidden lg:flex items-center gap-8">
                    ...
                    <a href="{{ route('monthly-feature.index') }}" class="text-base font-semibold text-gray-700 hover:text-primary-600 transition-colors duration-200 relative group">
                        Káva měsíce
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-primary-500 to-pink-600 group-hover:w-full transition-all duration-300"></span>
                    </a>
                    ...
                    <a href="{{ route('roasteries.index') }}" class="text-base font-semibold text-gray-700 hover:text-primary-600 transition-colors duration-200 relative group">
                        Naše pražírny
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-primary-500 to-pink-600 group-hover:w-full transition-all duration-300"></span>
                    </a>
                ...
                <div class="flex items-center gap-4">
                    <!-- CTA Button - Desktop -->
                    <a href="{{ route('subscriptions.index') }}" class="hidden lg:inline-flex items-center gap-2 bg-gradient-to-r from-primary-500 to-pink-600 hover:from-primary-600 hover:to-pink-700 text-white font-bold px-6 py-2.5 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                    ...
                    <!-- User Account -->
                    @auth
                    <a href="{{ route('dashboard.index') }}" class="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors duration-200" title="Můj účet">
                        <svg class="w-5 h-5 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                    </a>
                    @else
                    <a href="{{ route('login') }}" class="hidden md:flex items-center gap-2 text-gray-700 hover:text-primary-600 font-semibold transition-colors duration-200">
        ...
        <div id="mobile-menu" class="lg:hidden absolute top-full left-0 right-0 bg-gradient-to-br from-white via-gray-50 to-white backdrop-blur-xl shadow-2xl border-t-2 border-gray-200" style="display: none;">
            <div class="max-w-screen-xl mx-auto px-6 py-8 space-y-2">
                <!-- Navigation Links -->
                <a href="{{ route('home') }}" class="group flex items-center justify-between text-gray-900 hover:text-primary-600 font-bold py-3.5 px-4 rounded-xl hover:bg-gradient-to-r hover:from-primary-50 hover:to-pink-50 transition-all duration-200">
                    <span>Domů</span>
                ...
                <a href="{{ route('subscriptions.index') }}" class="group flex items-center justify-between text-gray-900 hover:text-primary-600 font-bold py-3.5 px-4 rounded-xl hover:bg-gradient-to-r hover:from-primary-50 hover:to-pink-50 transition-all duration-200">
                    <span>Předplatné</span>
                    <svg class="w-5 h-5 opacity-0 group-hover:opacity-100 transform group-hover:translate-x-1 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                </a>
                <a href="{{ route('monthly-feature.index') }}" class="group flex items-center justify-between text-gray-900 hover:text-primary-600 font-bold py-3.5 px-4 rounded-xl hover:bg-gradient-to-r hover:from-primary-50 hover:to-pink-50 transition-all duration-200">
                    <span>Káva měsíce</span>
                    <svg class="w-5 h-5 opacity-0 group-hover:opacity-100 transform group-hover:translate-x-1 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                </a>
                <a href="{{ route('products.index') }}" class="group flex items-center justify-between text-gray-900 hover:text-primary-600 font-bold py-3.5 px-4 rounded-xl hover:bg-gradient-to-r hover:from-primary-50 hover:to-pink-50 transition-all duration-200">
                    <span>Obchod</span>
                    <svg class="w-5 h-5 opacity-0 group-hover:opacity-100 transform group-hover:translate-x-1 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                </a>
                <a href="{{ route('roasteries.index') }}" class="group flex items-center justify-between text-gray-900 hover:text-primary-600 font-bold py-3.5 px-4 rounded-xl hover:bg-gradient-to-r hover:from-primary-50 hover:to-pink-50 transition-all duration-200">
                ...
                <!-- Mobile CTA Button -->
                <div class="pt-4">
                    <a href="{{ route('subscriptions.index') }}" class="flex items-center justify-center gap-2 bg-gradient-to-r from-primary-500 to-pink-600 hover:from-primary-600 hover:to-pink-700 text-white font-bold px-6 py-4 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                        <span>Vybrat předplatné</span>
                ...
                <div class="pt-6 mt-4 border-t-2 border-gray-200 space-y-2">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="flex items-center gap-3 text-gray-900 hover:text-primary-600 font-semibold py-3 px-4 rounded-xl hover:bg-gray-100 transition-all">
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                            </svg>
                            <span>Přihlásit se</span>
                        </a>
                        <a href="{{ route('register') }}" class="flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-800 text-white px-6 py-3.5 font-bold transition-all text-center rounded-xl shadow-md hover:shadow-lg">
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="mx-auto max-w-screen-xl px-4 md:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 pt-16 pb-12">
          ...
          <div class="lg:col-span-2">
            <a href="{{ route('home') }}" class="inline-flex items-center gap-2 mb-6 group" aria-label="logo">
          ...
          <div>
            ...
            <nav class="space-y-3">
              <a href="{{ route('subscriptions.index') }}" class="block text-gray-400 hover:text-primary-400 transition-colors duration-200">Konfigurátor</a>
              <a href="{{ route('subscriptions.index') }}" class="block text-gray-400 hover:text-primary-400 transition-colors duration-200">Espresso BOX</a>
              <a href="{{ route('subscriptions.index') }}" class="block text-gray-400 hover:text-primary-400 transition-colors duration-200">Filter BOX</a>
              <a href="{{ route('subscriptions.index') }}" class="block text-gray-400 hover:text-primary-400 transition-colors duration-200">Dárkové</a>
            </nav>
          </div>
          ...
          <div>
            ...
            <nav class="space-y-3">
              <a href="{{ route('products.index') }}" class="block text-gray-400 hover:text-primary-400 transition-colors duration-200">Všechny produkty</a>
              <a href="{{ route('products.index', ['category' => 'coffee']) }}" class="block text-gray-400 hover:text-primary-400 transition-colors duration-200">Káva</a>
              <a href="{{ route('products.index', ['category' => 'equipment']) }}" class="block text-gray-400 hover:text-primary-400 transition-colors duration-200">Vybavení</a>
              <a href="{{ route('products.index', ['category' => 'merch']) }}" class="block text-gray-400 hover:text-primary-400 transition-colors duration-200">Merch</a>
            </nav>
          </div>
