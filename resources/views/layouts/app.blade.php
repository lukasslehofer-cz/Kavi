    ...
    <header class="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
        ...
        <div id="mobile-menu" class="lg:hidden border-t border-gray-200 bg-white" style="display: none;">
            <div class="max-w-screen-xl mx-auto px-4 py-6 space-y-4">
                <a href="{{ route('home') }}" class="block text-gray-700 hover:text-primary-600 font-semibold py-2 transition-colors">Domů</a>
                <a href="{{ route('subscriptions.index') }}" class="block text-gray-700 hover:text-primary-600 font-semibold py-2 transition-colors">Předplatné</a>
                <a href="{{ route('products.index') }}" class="block text-gray-700 hover:text-primary-600 font-semibold py-2 transition-colors">Obchod</a>
                <a href="#" class="block text-gray-700 hover:text-primary-600 font-semibold py-2 transition-colors">O nás</a>
                
                <!-- Mobile CTA Button -->
                <a href="{{ route('subscriptions.index') }}" class="flex items-center justify-center gap-2 bg-gradient-to-r from-primary-500 to-pink-600 text-white font-bold px-6 py-3 rounded-xl shadow-lg mt-4">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                    </svg>
                    <span>Vybrat předplatné</span>
                ...
                <div class="pt-4 mt-4 border-t border-gray-200">
                    @auth
                        <a href="{{ route('dashboard.index') }}" class="block text-gray-700 hover:text-primary-600 font-semibold py-2 transition-colors">Můj účet</a>
                        @if(auth()->user()->is_admin)
                        <a href="{{ route('admin.dashboard') }}" class="block text-gray-700 hover:text-primary-600 font-semibold py-2 transition-colors">Admin</a>
                        @endif
                    ...
                    @else
                        <a href="{{ route('login') }}" class="block text-gray-700 hover:text-primary-600 font-semibold py-2 transition-colors">Přihlásit se</a>
                        <a href="{{ route('register') }}" class="block bg-gray-900 hover:bg-gray-800 text-white px-6 py-3 font-semibold transition-all text-center mt-2 rounded-xl">Registrovat</a>
                    @endauth
                </div>
            </div>
        </div>
