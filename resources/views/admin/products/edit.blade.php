        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="short_description_en" id="short_description_en" value="{{ old('short_description_en', $product->short_description_en) }}" 
            ...
            <div id="coffee-attributes-section" class="bg-gray-50 border-2 border-gray-200 p-6 rounded-lg space-y-4" style="display: {{ $isCoffee ? 'block' : 'none' }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="origin" id="origin" value="{{ old('origin', $product->attributes['origin'] ?? '') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="origin_en" id="origin_en" value="{{ old('origin_en', $product->attributes['origin_en'] ?? '') }}" 
                ...
                <div>
                    ...
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-xs text-gray-600 mt-1">Pouze číslo nebo rozsah v metrech, jednotka se na webu doplní automaticky (CZ: m n.m., EN: masl).</p>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-900 mb-2">Zpracování 🇨🇿</label>
                        <input type="text" name="processing" id="processing" value="{{ old('processing', $product->attributes['processing'] ?? '') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="processing_en" id="processing_en" value="{{ old('processing_en', $product->attributes['processing_en'] ?? '') }}" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="variety" id="variety" value="{{ old('variety', $product->attributes['variety'] ?? '') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="variety_en" id="variety_en" value="{{ old('variety_en', $product->attributes['variety_en'] ?? '') }}" 
