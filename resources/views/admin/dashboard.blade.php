...
<div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="relative overflow-hidden bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
            <div class="p-6 text-white">
                ...
                <p class="text-4xl font-bold">{{ number_format($stats['total_revenue'], 0, ',', ' ') }}<span class="text-2xl"> Kč</span></p>
            </div>
            <div class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16"></div>
        </div>
        ...
        <div class="relative overflow-hidden bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
            <div class="p-6 text-white">
                ...
                <p class="text-4xl font-bold">{{ $stats['active_subscriptions'] }}</p>
            </div>
            <div class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16"></div>
        </div>
        ...
        <div class="relative overflow-hidden bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
            <div class="p-6 text-white">
                ...
                <p class="text-4xl font-bold">{{ $stats['total_customers'] }}</p>
            </div>
            <div class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16"></div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        <!-- Add Product -->
        <a href="{{ route('admin.products.create') }}" class="group bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all border border-gray-200 hover:border-gray-300">
        ...
        <!-- Shipments -->
        <a href="{{ route('admin.subscriptions.shipments') }}" class="group bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all border border-gray-200 hover:border-gray-300">
            <div class="flex items-center gap-4">
        ...
        <a href="{{ route('admin.subscription-config.index') }}" class="group bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-all border border-gray-200 hover:border-gray-300">
            <div class="flex items-center gap-4">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            ...
            <a href="{{ route('admin.orders.index') }}" class="text-sm font-medium text-gray-700 hover:text-gray-900">
                Zobrazit vše →
            </a>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <a href="{{ route('admin.orders.show', $order) }}" class="text-blue-600 hover:text-blue-800 font-medium">Detail →</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mt-8">
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            ...
            <a href="{{ route('admin.subscriptions.index') }}" class="text-sm font-medium text-gray-700 hover:text-gray-900">
                Zobrazit vše →
            </a>
        </div>
        <div class="overflow-x-auto">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm text-gray-900">
                                {{ $subscription->plan ? $subscription->plan->name : 'Vlastní' }}
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <a href="{{ route('admin.subscriptions.show', $subscription) }}" class="text-blue-600 hover:text-blue-800 font-medium">Detail →</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
