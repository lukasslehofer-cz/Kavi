...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="card p-6 mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <a href="{{ route('admin.subscriptions.index') }}" class="btn btn-outline text-center">
                Spravovat předplatná
            </a>
            <a href="{{ route('admin.subscriptions.shipments') }}" class="btn btn-primary text-center">
    ...
    <div class="card mt-12">
        <div class="p-6 border-b border-cream-200">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('admin.subscriptions.index') }}" class="text-coffee-700 hover:text-coffee-900 font-semibold">
                    Zobrazit všechny →
                </a>
            </div>
        </div>
            ...
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-cream-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm text-coffee-900">{{ $subscription->user->name ?? 'Host' }}</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <a href="{{ route('admin.subscriptions.show', $subscription) }}" class="text-coffee-700 hover:text-coffee-900 underline">Detail</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
