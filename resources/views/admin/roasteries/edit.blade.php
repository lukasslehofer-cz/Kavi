                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="name" value="{{ old('name', $roastery->name) }}" required 
                            ...
                            <div>
                                ...
                                <input type="text" name="name_en" value="{{ old('name_en', $roastery->name_en) }}" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="country_en" value="{{ old('country_en', $roastery->country_en) }}" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="city" value="{{ old('city', $roastery->city) }}" 
                            ...
                            <div>
                                ...
                                <input type="text" name="city_en" value="{{ old('city_en', $roastery->city_en) }}" 
