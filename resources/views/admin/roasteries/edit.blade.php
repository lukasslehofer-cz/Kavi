...
@section('title', 'Upravit pražírnu')

@section('content')
<div class="p-6">
    <div class="max-w-4xl mx-auto">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Upravit pražírnu</h1>
            <p class="text-gray-600 mt-1">Upravte informace o pražírně</p>
        </div>

        <form action="{{ route('admin.roasteries.update', $roastery) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            @csrf
            @method('PUT')
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $roastery->name) }}" required 
                            ...
                            <div>
                                ...
                                <input type="text" name="name_en" id="name_en" value="{{ old('name_en', $roastery->name_en) }}" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="country" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('country') border-red-500 @enderror" id="country-select">
                                    ...
                                    <option value="{{ $country }}" data-flag="{{ $flag }}" {{ old('country', $roastery->country) == $country ? 'selected' : '' }}>
                                        {{ $flag }} {{ $country }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="country_en" id="country_en" value="{{ old('country_en', $roastery->country_en) }}" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="city" id="city" value="{{ old('city', $roastery->city) }}" 
                            ...
                            <div>
                                ...
                                <input type="text" name="city_en" id="city_en" value="{{ old('city_en', $roastery->city_en) }}" 
                        ...
                        <div>
                            ...
                            <textarea name="address" rows="2" 
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('address') border-red-500 @enderror">{{ old('address', $roastery->address) }}</textarea>
                            @error('address')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="url" name="website_url" value="{{ old('website_url', $roastery->website_url) }}" placeholder="https://..." 
                        ...
                        <div>
                            ...
                            <input type="text" name="instagram" value="{{ old('instagram', $roastery->instagram) }}" placeholder="@prazirna" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <textarea name="short_description" id="short_description" rows="3" maxlength="500" 
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('short_description') border-red-500 @enderror">{{ old('short_description', $roastery->short_description) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="short_description_en" id="short_description_en" rows="3" maxlength="500" 
                                          ...
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('short_description_en') border-red-500 @enderror">{{ old('short_description_en', $roastery->short_description_en) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <textarea name="full_description" id="full_description" rows="8" 
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('full_description') border-red-500 @enderror">{{ old('full_description', $roastery->full_description) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="full_description_en" id="full_description_en" rows="8" 
                                          ...
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('full_description_en') border-red-500 @enderror">{{ old('full_description_en', $roastery->full_description_en) }}</textarea>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <img src="{{ asset($roastery->image) }}" alt="{{ $roastery->name }}" 
                            ...
                            <div id="main-preview-container" class="mt-4 hidden">
                                ...
                                <img id="main-preview" src="" alt="Náhled" 
                                     class="w-48 h-48 object-cover rounded-lg border-2 border-blue-500">
                            </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Galerie (max 4 fotky celkem)</label>
                            
                            @if($roastery->gallery && count($roastery->gallery) > 0)
                            <div class="mb-4">
                                <p class="text-sm text-gray-600 mb-2">Aktuální galerie:</p>
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    @foreach($roastery->gallery as $galleryImage)
                                    <div class="relative">
                                        <img src="{{ asset($galleryImage) }}" alt="Gallery" 
                            ...
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <p class="text-xs text-gray-500 mt-1">Můžete přidat nové fotky (max 4 celkem). Zaškrtněte fotky, které chcete smazat.</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="sort_order" value="{{ old('sort_order', $roastery->sort_order) }}" min="0" 
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $roastery->is_active) ? 'checked' : '' }}
            ...
            <input type="hidden" name="country_flag" id="country-flag-input" value="{{ old('country_flag', $roastery->country_flag) }}">
    ...
    files.forEach((file, index) => {
        ...
        reader.onload = function(e) {
            ...
            div.innerHTML = `
                ...
                <span class="absolute top-2 right-2 bg-gray-900 text-white text-xs px-2 py-1 rounded">Nová ${index + 1}</span>
            `;
