...
<div class="p-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="relative flex-1">
                            ...
                            >
                            <span class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-600 text-sm font-medium">
                                {{ str_contains($config->key, '_eur') ? '€' : 'Kč' }}
                            </span>
                        </div>
    ...
    <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
        ...
        <div class="space-y-3 text-sm text-gray-700">
            ...
            <p>
                <strong>Promo obrázek:</strong> Obrázek kávy pro danou rozesílku, který se zobrazí na stránce /predplatne v levém sloupci. Obrázky jsou uloženy v úložišti a zobrazují se dynamicky podle aktuálního měsíce.
            </p>
...
function deletePromoImage(scheduleId, monthName) {
    if (!confirm(`Opravdu chcete smazat promo obrázek pro měsíc ${monthName}?`)) {
        return;
    }
    ...
    .then(data => {
        if (data.success) {
            ...
            alert('Chyba při mazání obrázku: ' + (data.message || 'Neznámá chyba'));
        }
    })
    .catch(error => {
