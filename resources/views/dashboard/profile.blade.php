...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-primary-500">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-4xl font-bold text-dark-800 mb-1">{{ auth()->user()->name }}</h1>
                <p class="text-lg text-dark-600">{{ auth()->user()->email }}</p>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold text-dark-800">{{ auth()->user()->orders()->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold text-dark-800">{{ auth()->user()->subscriptions()->where('status', 'active')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-dark-800">{{ auth()->user()->created_at->format('m/Y') }}</p>
                </div>
            </div>
        </div>
    </div>
