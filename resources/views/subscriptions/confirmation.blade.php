    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-slate-50 p-6 rounded-xl border border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-black text-gray-900">{{ $frequencyText }}</div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-600">{{ $frequencyText }}</div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 pt-6 border-t-2 border-gray-200 space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-sm text-gray-700">
                                    <strong class="text-primary-600">{{ $shippingInfo['next_shipping_date']->format('j. n. Y') }}</strong>
                                    (20. den v měsíci)
                                </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-sm text-gray-700">
                                    <strong class="text-green-600">{{ $nextPaymentDate->format('j. n. Y') }}</strong>
                                    (15. den v měsíci)
                                </div>
                                <div class="text-xs text-gray-600 mt-1">
                    ...
                    <div class="space-y-3 text-gray-700">
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-bold text-gray-900">{{ $subscription->shipping_address['name'] }}</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-bold text-gray-900">{{ $subscription->shipping_address['email'] }}</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-bold text-gray-900">{{ $subscription->shipping_address['phone'] }}</div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-bold text-gray-900">{{ $subscription->shipping_address['billing_address'] }}, {{ $subscription->shipping_address['billing_postal_code'] }} {{ $subscription->shipping_address['billing_city'] }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-xl border-2 border-primary-200">
                ...
                <div class="bg-gradient-to-r from-orange-50 to-red-50 p-6 rounded-xl border-2 border-[#ba1b02]/20 shadow-md">
                    ...
                    <div class="text-lg font-black text-gray-900 mb-1">{{ $subscription->packeta_point_name }}</div>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-2xl p-8 sticky top-24 shadow-xl border-2 border-gray-200">
                ...
                <div class="space-y-3">
                    <a href="{{ route('dashboard.subscription') }}" class="block w-full text-center bg-gradient-to-r from-primary-500 to-pink-600 hover:from-primary-600 hover:to-pink-700 text-white font-bold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                        Zobrazit předplatné
                    </a>
                    
                    <a href="{{ route('home') }}" class="block w-full text-center bg-white hover:bg-gray-50 text-gray-900 font-semibold px-8 py-3 rounded-xl shadow-md hover:shadow-lg border-2 border-gray-200 hover:border-gray-300 transition-all duration-200">
                        Zpět na homepage
                    </a>
                </div>
